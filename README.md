...
[![Javadocs](https://travis-ci.com/IBM/platform-services-java-sdk.svg?branch=master)](https://ibm.github.io/platform-services-java-sdk/docs/latest)

# IBM Cloud Platform Services Java SDK Version 0.1.2
...
```gradle
'com.ibm.cloud:platform-services:0.1.2'
```
...
##### Gradle
```gradle
'com.ibm.cloud:global-search:0.1.2'
```
