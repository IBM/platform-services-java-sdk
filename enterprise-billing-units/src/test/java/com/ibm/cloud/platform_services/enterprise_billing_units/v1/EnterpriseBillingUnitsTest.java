...
public class EnterpriseBillingUnitsTest {
  ...
  public void testGetBillingUnitWOptions() throws Throwable {
    ...
    String mockResponseBody = "{\"id\": \"id\", \"crn\": \"crn:v1:bluemix:public:billing::a/<<enterprise_account_id>>::billing-unit:<<billing_unit_id>>\", \"name\": \"name\", \"enterprise_id\": \"enterpriseId\", \"currency_code\": \"USD\", \"country_code\": \"USA\", \"master\": true, \"created_at\": \"2019-05-01T00:00:00.000Z\"}";
  ...
  public void testListBillingUnitsWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "{\"rows_count\": 9, \"next_url\": \"nextUrl\", \"resources\": [{\"id\": \"id\", \"crn\": \"crn:v1:bluemix:public:billing::a/<<enterprise_account_id>>::billing-unit:<<billing_unit_id>>\", \"name\": \"name\", \"enterprise_id\": \"enterpriseId\", \"currency_code\": \"USD\", \"country_code\": \"USA\", \"master\": true, \"created_at\": \"2019-05-01T00:00:00.000Z\"}]}";
  ...
  public void testListBillingOptionsWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "{\"rows_count\": 9, \"next_url\": \"nextUrl\", \"resources\": [{\"id\": \"id\", \"billing_unit_id\": \"billingUnitId\", \"start_date\": \"2019-05-01T00:00:00.000Z\", \"end_date\": \"2020-05-01T00:00:00.000Z\", \"state\": \"ACTIVE\", \"type\": \"SUBSCRIPTION\", \"category\": \"PLATFORM\", \"payment_instrument\": {\"anyKey\": \"anyValue\"}, \"duration_in_months\": 11, \"line_item_id\": 10, \"billing_system\": {\"anyKey\": \"anyValue\"}, \"renewal_mode_code\": \"renewalModeCode\", \"updated_at\": \"2019-06-01T00:00:00.000Z\"}]}";
