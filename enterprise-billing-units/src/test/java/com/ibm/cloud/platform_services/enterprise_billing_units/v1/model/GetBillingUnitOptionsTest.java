...
/**
 * Unit test class for the GetBillingUnitOptions model.
 */
public class GetBillingUnitOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetBillingUnitOptions() throws Throwable {
    GetBillingUnitOptions getBillingUnitOptionsModel = new GetBillingUnitOptions.Builder()
      .billingUnitId("testString")
      .build();
    assertEquals(getBillingUnitOptionsModel.billingUnitId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetBillingUnitOptionsError() throws Throwable {
    new GetBillingUnitOptions.Builder().build();
  }
