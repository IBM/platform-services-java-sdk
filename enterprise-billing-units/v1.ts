...
class EnterpriseBillingUnitsV1 extends BaseService {
   ...
   * @returns {Promise<EnterpriseBillingUnitsV1.Response<EnterpriseBillingUnitsV1.BillingOption>>}
   */
  public getBillingOptionByQuery(params: EnterpriseBillingUnitsV1.GetBillingOptionByQueryParams): Promise<EnterpriseBillingUnitsV1.Response<EnterpriseBillingUnitsV1.BillingOption>> {
    ...
    return new Promise((resolve, reject) => {
      ...
      const sdkHeaders = getSdkHeaders(EnterpriseBillingUnitsV1.DEFAULT_SERVICE_NAME, 'v1', 'getBillingOptionByQuery');
   ...
   */
  public getBillingUnitById(params: EnterpriseBillingUnitsV1.GetBillingUnitByIdParams): Promise<EnterpriseBillingUnitsV1.Response<EnterpriseBillingUnitsV1.BillingUnit>> {
    const _params = extend({}, params);
    const requiredParams = ['billingUnitId'];
    ...
    return new Promise((resolve, reject) => {
      ...
      const sdkHeaders = getSdkHeaders(EnterpriseBillingUnitsV1.DEFAULT_SERVICE_NAME, 'v1', 'getBillingUnitById');
   ...
   * @param {OutgoingHttpHeaders} [params.headers] - Custom request headers
   * @returns {Promise<EnterpriseBillingUnitsV1.Response<EnterpriseBillingUnitsV1.ResponseBillingUnitsByQuery>>}
   */
  public getBillingUnitByQuery(params?: EnterpriseBillingUnitsV1.GetBillingUnitByQueryParams): Promise<EnterpriseBillingUnitsV1.Response<EnterpriseBillingUnitsV1.ResponseBillingUnitsByQuery>> {
    const _params = extend({}, params);
    ...
    return new Promise((resolve, reject) => {
      ...
      const sdkHeaders = getSdkHeaders(EnterpriseBillingUnitsV1.DEFAULT_SERVICE_NAME, 'v1', 'getBillingUnitByQuery');
   ...
   * @param {OutgoingHttpHeaders} [params.headers] - Custom request headers
   * @returns {Promise<EnterpriseBillingUnitsV1.Response<EnterpriseBillingUnitsV1.ResponseCreditPoolsByQuery>>}
   */
  public getCreditPools(params: EnterpriseBillingUnitsV1.GetCreditPoolsParams): Promise<EnterpriseBillingUnitsV1.Response<EnterpriseBillingUnitsV1.ResponseCreditPoolsByQuery>> {
    const _params = extend({}, params);
    const requiredParams = ['billingUnitId'];
...
namespace EnterpriseBillingUnitsV1 {
  ...
  /** Parameters for the `getBillingOptionByQuery` operation. */
  export interface GetBillingOptionByQueryParams {
    /** The billing unit ID. */
    billingUnitId: string;
    headers?: OutgoingHttpHeaders;
  }

  /** Parameters for the `getBillingUnitById` operation. */
  export interface GetBillingUnitByIdParams {
    /** The ID of the requested billing unit. */
    billingUnitId: string;
    headers?: OutgoingHttpHeaders;
  }

  /** Parameters for the `getBillingUnitByQuery` operation. */
  export interface GetBillingUnitByQueryParams {
  ...
  /** Aggregated usage and charges for all the plans in the account. */
  export interface ResponseBillingUnitsByQuery {
  ...
  /** Aggregated usage and charges for all the plans in the account. */
  export interface ResponseCreditPoolsByQuery {
