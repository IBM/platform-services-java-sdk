...
class EnterpriseUsageReportsV1 extends BaseService {
   ...
   */
  public listResourceUsageReport(params?: EnterpriseUsageReportsV1.ListResourceUsageReportParams): Promise<EnterpriseUsageReportsV1.Response<EnterpriseUsageReportsV1.Reports>> {
    ...
    return new Promise((resolve, reject) => {
      ...
      const sdkHeaders = getSdkHeaders(EnterpriseUsageReportsV1.DEFAULT_SERVICE_NAME, 'v1', 'listResourceUsageReport');
...
namespace EnterpriseUsageReportsV1 {
  ...
  /** Parameters for the `listResourceUsageReport` operation. */
  export interface ListResourceUsageReportParams {
  ...
  export interface MetricUsageModel {
  ...
  export interface Reports {
    ...
    reports?: ResourceUsageReportModel[];
  }

  /** An object that contains the link to the first page of the search query. */
  export interface ReportsFirst {
    /** A link to the first page of the search query. */
    href?: string;
  }

  /** An object that contains the link to the first page of the search query. */
  export interface ReportsNext {
    /** A link to the first page of the search query. */
    href?: string;
  }
  ...
  export interface ResourceUsageModel {
    ...
    plans: PlanUsageModel[];
  }

  /** An object that represents a usage report. */
  export interface ResourceUsageReportModel {
