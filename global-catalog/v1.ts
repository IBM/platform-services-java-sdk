...
class GlobalCatalogV1 extends BaseService {
   ...
   * @param {string[]} params.geoTags - A list of tags representing deployment locations, for example, `us-south`,
   * `eu-gb`, `us-south-dal10`.
   * @param {string[]} params.pricingTags - A list of tags representing pricing types, for example, free lite,
   ...
   * @param {string} [params.catalogCrn] - The cloud resource name of the catalog entry.
   * @param {string} [params.url] - The catalog URL for the catalog entry.
   * @param {string} [params.parentId] - The ID of the parent catalog entry if it exists.
   * @param {string} [params.childrenUrl] - The catalog URL of child elements for the catalog entry.
   * @param {string} [params.parentUrl] - The catalog URL of the parent catalog entry.
   * @param {string} [params.created] - The date the catalog entry was created.
   * @param {string} [params.updated] - The date the catalog entry was last updated.
   * @param {ObjectMetaData} [params.metadata] - Metadata is not returned by default, and includes specific data
   * depending on the object **kind**.
   * @param {boolean} [params.active] - Boolean value that describes whether the service is active.
   * @param {CatalogEntry[]} [params.children] - The children of this catalog entry. This is read-only and ignored on
   * put or post. It is filled in when `?depth=_value_` is used.
   * @param {string} [params.account] - This changes the scope of the request regardless of the authorization header.
   * Example scopes are `account` and `global`. `account=global` is reqired if operating with a service ID that has a
   * global admin policy, for example `GET /?account=global`.
   * @param {OutgoingHttpHeaders} [params.headers] - Custom request headers
   ...
   */
  public createCatalogEntry(params: GlobalCatalogV1.CreateCatalogEntryParams): Promise<GlobalCatalogV1.Response<GlobalCatalogV1.Empty>> {
    const _params = extend({}, params);
    const requiredParams = ['id', 'name', 'overviewUi', 'kind', 'images', 'disabled', 'tags', 'geoTags', 'pricingTags', 'group', 'provider'];
    ...
    return new Promise((resolve, reject) => {
      ...
      const body = {
        ...
        'tags': _params.tags,
        'geo_tags': _params.geoTags,
        'pricing_tags': _params.pricingTags,
        'group': _params.group,
        'provider': _params.provider,
        'catalog_crn': _params.catalogCrn,
        'url': _params.url,
        'parent_id': _params.parentId,
        'children_url': _params.childrenUrl,
        'parent_url': _params.parentUrl,
   ...
   * @param {string} params.newId - Catalog entry's unique ID. It's the same across all catalog instances.
   * @param {string} params.newName - Programmatic name for this catalog entry, which must be formatted like a CRN
   * segment. See the display name in OverviewUI for a user-readable name.
   * @param {OverviewUI} params.newOverviewUi - Overview is nested in the top level. The key value pair is
   * `[_language_]overview_ui`.
   * @param {string} params.newKind - The type of catalog entry, **service**, **template**, **dashboard**, which
   * determines the type and shape of the object.
   * @param {Image} params.newImages - Image annotation for this catalog entry. The image is a URL.
   * @param {boolean} params.newDisabled - Boolean value that determines the global visibility for the catalog entry,
   * and its children. If it is not enabled, all plans are disabled.
   * @param {string[]} params.newTags - A list of tags. For example, IBM, 3rd Party, Beta, GA, and Single Tenant.
   * @param {string[]} params.newGeoTags - A list of tags representing deployment locations, for example, `us-south`,
   * `eu-gb`, `us-south-dal10`.
   * @param {string[]} params.newPricingTags - A list of tags representing pricing types, for example, free lite,
   * subscription, paid only.
   * @param {boolean} params.newGroup - Boolean value that determines whether the catalog entry is a group.
   * @param {Provider} params.newProvider - Information related to the provider associated with a catalog entry.
   * @param {string} [params.newCatalogCrn] - The cloud resource name of the catalog entry.
   * @param {string} [params.newUrl] - The catalog URL for the catalog entry.
   * @param {string} [params.newParentId] - The ID of the parent catalog entry if it exists.
   * @param {string} [params.newChildrenUrl] - The catalog URL of child elements for the catalog entry.
   * @param {string} [params.newParentUrl] - The catalog URL of the parent catalog entry.
   * @param {string} [params.newCreated] - The date the catalog entry was created.
   * @param {string} [params.newUpdated] - The date the catalog entry was last updated.
   * @param {ObjectMetaData} [params.newMetadata] - Metadata is not returned by default, and includes specific data
   * depending on the object **kind**.
   * @param {boolean} [params.newActive] - Boolean value that describes whether the service is active.
   * @param {CatalogEntry[]} [params.newChildren] - The children of this catalog entry. This is read-only and ignored on
   * put or post. It is filled in when `?depth=_value_` is used.
   * @param {string} [params.account] - This changes the scope of the request regardless of the authorization header.
   * Example scopes are `account` and `global`. `account=global` is reqired if operating with a service ID that has a
   * global admin policy, for example `GET /?account=global`.
   ...
   * @returns {Promise<GlobalCatalogV1.Response<GlobalCatalogV1.Empty>>}
   */
  public updateCatalogEntry(params: GlobalCatalogV1.UpdateCatalogEntryParams): Promise<GlobalCatalogV1.Response<GlobalCatalogV1.Empty>> {
    const _params = extend({}, params);
    const requiredParams = ['id', 'newId', 'newName', 'newOverviewUi', 'newKind', 'newImages', 'newDisabled', 'newTags', 'newGeoTags', 'newPricingTags', 'newGroup', 'newProvider'];
    ...
    return new Promise((resolve, reject) => {
      ...
      const body = {
        ...
        'overview_ui': _params.newOverviewUi,
        'kind': _params.newKind,
        'images': _params.newImages,
        'disabled': _params.newDisabled,
        'tags': _params.newTags,
        'geo_tags': _params.newGeoTags,
        'pricing_tags': _params.newPricingTags,
        'group': _params.newGroup,
        'provider': _params.newProvider,
        'catalog_crn': _params.newCatalogCrn,
        'url': _params.newUrl,
        'parent_id': _params.newParentId,
        'children_url': _params.newChildrenUrl,
        'parent_url': _params.newParentUrl,
        'created': _params.newCreated,
        'updated': _params.newUpdated,
        'metadata': _params.newMetadata,
        'active': _params.newActive,
        'children': _params.newChildren
      };
   ...
   * @returns {Promise<GlobalCatalogV1.Response<GlobalCatalogV1.Empty>>}
   */
  public archiveCatalogEntry(params: GlobalCatalogV1.ArchiveCatalogEntryParams): Promise<GlobalCatalogV1.Response<GlobalCatalogV1.Empty>> {
    const _params = extend({}, params);
    const requiredParams = ['id'];
    ...
    return new Promise((resolve, reject) => {
      ...
      const sdkHeaders = getSdkHeaders(GlobalCatalogV1.DEFAULT_SERVICE_NAME, 'v1', 'archiveCatalogEntry');
   ...
   * *ibm_only*, and *private*. public means it is visible to all. ibm_only means it is visible to all IBM unless their
   * account is explicitly excluded. private means it is visible only to the included accounts.
   * @param {Scope} [params.owner] - IAM Scope-related information associated with a catalog entry.
   ...
   * @param {boolean} [params.approved] - Determines whether the owning account has full control over the visibility of
   * the entry such as adding non-IBM accounts to the whitelist and making entries `private`, `ibm_only` or `public`.
   * @param {string} [params.account] - This changes the scope of the request regardless of the authorization header.
   * Example scopes are `account` and `global`. `account=global` is reqired if operating with a service ID that has a
   * global admin policy, for example `GET /?account=global`.
   * @param {OutgoingHttpHeaders} [params.headers] - Custom request headers
   ...
   * global admin policy, for example `GET /?account=global`.
   * @param {OutgoingHttpHeaders} [params.headers] - Custom request headers
   * @returns {Promise<GlobalCatalogV1.Response<GlobalCatalogV1.Pricing>>}
   */
  public getPricing(params: GlobalCatalogV1.GetPricingParams): Promise<GlobalCatalogV1.Response<GlobalCatalogV1.Pricing>> {
    const _params = extend({}, params);
    const requiredParams = ['id'];
...
namespace GlobalCatalogV1 {
  ...
  export interface UpdateCatalogEntryParams {
    ...
    newGeoTags: string[];
    /** A list of tags representing pricing types, for example, free lite, subscription, paid only. */
    newPricingTags: string[];
    /** Boolean value that determines whether the catalog entry is a group. */
    newGroup: boolean;
    /** Information related to the provider associated with a catalog entry. */
    newProvider: Provider;
    /** The cloud resource name of the catalog entry. */
    newCatalogCrn?: string;
    /** The catalog URL for the catalog entry. */
    newUrl?: string;
    /** The ID of the parent catalog entry if it exists. */
    newParentId?: string;
    /** The catalog URL of child elements for the catalog entry. */
    newChildrenUrl?: string;
    /** The catalog URL of the parent catalog entry. */
    newParentUrl?: string;
    /** The date the catalog entry was created. */
    newCreated?: string;
  ...
  /** Parameters for the `archiveCatalogEntry` operation. */
  export interface ArchiveCatalogEntryParams {
    /** The object's unique ID. */
    id: string;
    /** This changes the scope of the request regardless of the authorization header. Example scopes are `account`
     *  and `global`. `account=global` is reqired if operating with a service ID that has a global admin policy, for
  ...
  export interface ObjectMetaData {
    ...
    plan?: ObjectMetaDataPlan;
    /** Template-related metadata. */
    template?: ObjectMetaDataTemplate;
    /** Deployment-related metadata. */
    deployment?: ObjectMetaDataDeployment;
    /** Alias-related metadata. */
    alias?: ObjectMetaDataAlias;
    /** Service Level Agreement related metadata. */
    sla?: ObjectMetaDataSla;
    /** Callback-related information associated with a catalog entry. */
    callbacks?: Callbacks;
  ...
  /** Alias-related metadata. */
  export interface ObjectMetaDataAlias {
    /** Type of alias. */
    type?: string;
  ...
  /** Deployment-related metadata. */
  export interface ObjectMetaDataDeployment {
    ...
    broker?: ObjectMetaDataDeploymentBroker;
  ...
  /** The broker associated with a catalog entry. */
  export interface ObjectMetaDataDeploymentBroker {
    /** Broker name. */
    name?: string;
    /** Broker guid. */
    guid?: string;
    /** Broker password. */
    password?: ObjectMetaDataDeploymentBrokerPassword;
  }

  /** Broker password. */
  export interface ObjectMetaDataDeploymentBrokerPassword {
  ...
  /** Plan-related metadata. */
  export interface ObjectMetaDataPlan {
  ...
  /** Service Level Agreement related metadata. */
  export interface ObjectMetaDataSla {
    ...
    dr?: ObjectMetaDataSlaDr;
  }

  /** SLA Disaster Recovery-related metadata. */
  export interface ObjectMetaDataSlaDr {
  ...
  /** Template-related metadata. */
  export interface ObjectMetaDataTemplate {
    ...
    source?: ObjectMetaDataTemplateSource;
    /** ID of the runtime. */
    ...
    environment_variables?: ObjectMetaDataTemplateEnvironmentVariables;
  }

  /** Environment variables for the template. */
  export interface ObjectMetaDataTemplateEnvironmentVariables {
    /** Key is the editable first string in a key:value pair of environment variables. */
    key?: string;
  }

  /** Location of your applications source files. */
  export interface ObjectMetaDataTemplateSource {
