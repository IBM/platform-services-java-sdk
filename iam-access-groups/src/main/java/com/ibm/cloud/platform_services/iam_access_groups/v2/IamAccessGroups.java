...
public class IamAccessGroups extends BaseService {
 ...
 /**
   ...
   * @return a {@link ServiceCall} with a result of type {@link CreateTemplateResponse}
   */
  public ServiceCall<CreateTemplateResponse> createTemplate(CreateTemplateOptions createTemplateOptions) {
    ...
    if (createTemplateOptions.accessGroup() != null) {
      contentJson.add("access_group", com.ibm.cloud.sdk.core.util.GsonSingleton.getGson().toJsonTree(createTemplateOptions.accessGroup()));
    }
    if (createTemplateOptions.policyTemplates() != null) {
      contentJson.add("policy_templates", com.ibm.cloud.sdk.core.util.GsonSingleton.getGson().toJsonTree(createTemplateOptions.policyTemplates()));
    }
    builder.bodyJson(contentJson);
    ResponseConverter<CreateTemplateResponse> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<CreateTemplateResponse>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
   ...
   * @return a {@link ServiceCall} with a result of type {@link CreateTemplateResponse}
   */
  public ServiceCall<CreateTemplateResponse> createTemplateVersion(CreateTemplateVersionOptions createTemplateVersionOptions) {
    ...
    if (createTemplateVersionOptions.accessGroup() != null) {
      contentJson.add("access_group", com.ibm.cloud.sdk.core.util.GsonSingleton.getGson().toJsonTree(createTemplateVersionOptions.accessGroup()));
    }
    if (createTemplateVersionOptions.policyTemplates() != null) {
      contentJson.add("policy_templates", com.ibm.cloud.sdk.core.util.GsonSingleton.getGson().toJsonTree(createTemplateVersionOptions.policyTemplates()));
    }
    builder.bodyJson(contentJson);
    ResponseConverter<CreateTemplateResponse> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<CreateTemplateResponse>() { }.getType());
   ...
   * @return a {@link ServiceCall} with a result of type {@link CreateTemplateResponse}
   */
  public ServiceCall<CreateTemplateResponse> getTemplateVersion(GetTemplateVersionOptions getTemplateVersionOptions) {
   ...
   * @return a {@link ServiceCall} with a result of type {@link CreateTemplateResponse}
   */
  public ServiceCall<CreateTemplateResponse> updateTemplateVersion(UpdateTemplateVersionOptions updateTemplateVersionOptions) {
    ...
    final JsonObject contentJson = new JsonObject();
    if (updateTemplateVersionOptions.id() != null) {
      contentJson.addProperty("id", updateTemplateVersionOptions.id());
    }
    ...
    if (updateTemplateVersionOptions.accountId() != null) {
      contentJson.addProperty("account_id", updateTemplateVersionOptions.accountId());
    }
    if (updateTemplateVersionOptions.version() != null) {
      contentJson.addProperty("version", updateTemplateVersionOptions.version());
    }
    if (updateTemplateVersionOptions.committed() != null) {
      contentJson.addProperty("committed", updateTemplateVersionOptions.committed());
    }
    if (updateTemplateVersionOptions.accessGroup() != null) {
      contentJson.add("access_group", com.ibm.cloud.sdk.core.util.GsonSingleton.getGson().toJsonTree(updateTemplateVersionOptions.accessGroup()));
    }
    if (updateTemplateVersionOptions.policyTemplates() != null) {
      contentJson.add("policy_templates", com.ibm.cloud.sdk.core.util.GsonSingleton.getGson().toJsonTree(updateTemplateVersionOptions.policyTemplates()));
    }
    if (updateTemplateVersionOptions.href() != null) {
      contentJson.addProperty("href", updateTemplateVersionOptions.href());
    }
    if (updateTemplateVersionOptions.createdAt() != null) {
      contentJson.add("created_at", com.ibm.cloud.sdk.core.util.GsonSingleton.getGson().toJsonTree(updateTemplateVersionOptions.createdAt()));
    }
    if (updateTemplateVersionOptions.createdById() != null) {
      contentJson.addProperty("created_by_id", updateTemplateVersionOptions.createdById());
    }
    if (updateTemplateVersionOptions.lastModifiedAt() != null) {
      contentJson.add("last_modified_at", com.ibm.cloud.sdk.core.util.GsonSingleton.getGson().toJsonTree(updateTemplateVersionOptions.lastModifiedAt()));
    }
    if (updateTemplateVersionOptions.lastModifiedById() != null) {
      contentJson.addProperty("last_modified_by_id", updateTemplateVersionOptions.lastModifiedById());
    }
    builder.bodyJson(contentJson);
    ResponseConverter<CreateTemplateResponse> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<CreateTemplateResponse>() { }.getType());
   ...
   * @return a {@link ServiceCall} with a result of type {@link CreateTemplateResponse}
   */
  public ServiceCall<CreateTemplateResponse> commitTemplate(CommitTemplateOptions commitTemplateOptions) {
   ...
   * @return a {@link ServiceCall} with a result of type {@link CreateTemplateResponse}
   */
  public ServiceCall<CreateTemplateResponse> getLatestTemplateVersion(GetLatestTemplateVersionOptions getLatestTemplateVersionOptions) {
   ...
   * @return a {@link ServiceCall} with a result of type {@link TemplateCreateAssignmentResponse}
   */
  public ServiceCall<TemplateCreateAssignmentResponse> createAssignment(CreateAssignmentOptions createAssignmentOptions) {
    ...
    builder.bodyJson(contentJson);
    ResponseConverter<TemplateCreateAssignmentResponse> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<TemplateCreateAssignmentResponse>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
   ...
   * @return a {@link ServiceCall} with a result of type {@link TemplatesListAssignmentResponse}
   */
  public ServiceCall<TemplatesListAssignmentResponse> listAssignments(ListAssignmentsOptions listAssignmentsOptions) {
    if (listAssignmentsOptions == null) {
      listAssignmentsOptions = new ListAssignmentsOptions.Builder().build();
    }
    ...
    builder.header("Accept", "application/json");
    if (listAssignmentsOptions.accountId() != null) {
      builder.query("account_id", String.valueOf(listAssignmentsOptions.accountId()));
    }
    ResponseConverter<TemplatesListAssignmentResponse> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<TemplatesListAssignmentResponse>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
   ...
   * @return a {@link ServiceCall} with a result of type {@link TemplatesListAssignmentResponse}
   */
  public ServiceCall<TemplatesListAssignmentResponse> listAssignments() {
    return listAssignments(null);
  }
   ...
   * @return a {@link ServiceCall} with a result of type {@link GetTemplateAssignmentResponse}
   */
  public ServiceCall<GetTemplateAssignmentResponse> getAssignment(GetAssignmentOptions getAssignmentOptions) {
    ...
    ResponseConverter<GetTemplateAssignmentResponse> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<GetTemplateAssignmentResponse>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
