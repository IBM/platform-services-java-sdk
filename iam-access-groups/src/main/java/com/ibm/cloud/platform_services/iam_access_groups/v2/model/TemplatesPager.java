...
public class TemplatesPager {
   ...
   * @return a List&lt;TemplateItem&gt; that contains the next page of results
   */
  public List<TemplateItem> getNext() {
    if (!hasNext()) {
    ...
    return result.getGroupsTemplates();
  }

  /**
   * Returns all results by invoking getNext() repeatedly until all pages of results have been retrieved.
   * @return a List&lt;TemplateItem&gt; containing all results returned by the "listTemplates" method
   */
  public List<TemplateItem> getAll() {
    List<TemplateItem> results = new ArrayList<>();
    while (hasNext()) {
      List<TemplateItem> nextPage = getNext();
