...
public class IamAccessGroupsTest {
  ...
  public void testCreateTemplateWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "{\"id\": \"id\", \"name\": \"name\", \"description\": \"description\", \"account_id\": \"accountId\", \"version\": \"version\", \"committed\": false, \"access_group\": {\"name\": \"name\", \"description\": \"description\", \"members\": {\"users\": [\"users\"], \"service_ids\": [\"serviceIds\"], \"action_controls\": {\"add\": false, \"remove\": true}}, \"assertions\": {\"rules\": [{\"name\": \"name\", \"expiration\": 10, \"realm_name\": \"realmName\", \"conditions\": [{\"claim\": \"claim\", \"operator\": \"operator\", \"value\": \"value\"}], \"action_controls\": {\"remove\": true, \"update\": true}}], \"action_controls\": {\"add\": false, \"remove\": true, \"update\": true}}, \"action_controls\": {\"access\": {\"add\": false}}}, \"policy_templates\": [{\"id\": \"id\", \"version\": \"version\"}], \"href\": \"href\", \"created_at\": \"2019-01-01T12:00:00.000Z\", \"created_by_id\": \"createdById\", \"last_modified_at\": \"2019-01-01T12:00:00.000Z\", \"last_modified_by_id\": \"lastModifiedById\"}";
    ...
    Response<CreateTemplateResponse> response = iamAccessGroupsService.createTemplate(createTemplateOptionsModel).execute();
    assertNotNull(response);
    CreateTemplateResponse responseObj = response.getResult();
    assertNotNull(responseObj);
  ...
  public void testListTemplatesWithPagerGetNext() throws Throwable {
    // Set up the two-page mock response.
    String mockResponsePage1 = "{\"next\":{\"href\":\"https://myhost.com/somePath?offset=1\"},\"total_count\":2,\"limit\":1,\"groups_templates\":[{\"id\":\"id\",\"name\":\"name\",\"description\":\"description\",\"version\":\"version\",\"created_at\":\"createdAt\",\"created_by_id\":\"createdById\",\"last_modified_at\":\"lastModifiedAt\",\"last_modified_by_id\":\"lastModifiedById\",\"href\":\"href\"}]}";
    String mockResponsePage2 = "{\"total_count\":2,\"limit\":1,\"groups_templates\":[{\"id\":\"id\",\"name\":\"name\",\"description\":\"description\",\"version\":\"version\",\"created_at\":\"createdAt\",\"created_by_id\":\"createdById\",\"last_modified_at\":\"lastModifiedAt\",\"last_modified_by_id\":\"lastModifiedById\",\"href\":\"href\"}]}";
    server.enqueue(new MockResponse()
      .setHeader("Content-type", "application/json")
      .setResponseCode(200)
      .setBody(mockResponsePage1));
  ...
  public void testListTemplatesWithPagerGetAll() throws Throwable {
    ...
    TemplatesPager pager = new TemplatesPager(iamAccessGroupsService, listTemplatesOptions);
    List<TemplateItem> allResults = pager.getAll();
    assertNotNull(allResults);
    assertEquals(allResults.size(), 2);
  }
  ...
  public void testCreateTemplateVersionWOptions() throws Throwable {
    ...
    Response<CreateTemplateResponse> response = iamAccessGroupsService.createTemplateVersion(createTemplateVersionOptionsModel).execute();
    assertNotNull(response);
    CreateTemplateResponse responseObj = response.getResult();
    assertNotNull(responseObj);
  ...
  public void testListTemplateVersionsWithPagerGetNext() throws Throwable {
    // Set up the two-page mock response.
    String mockResponsePage1 = "{\"next\":{\"href\":\"https://myhost.com/somePath?offset=1\"},\"versions\":[{\"name\":\"name\",\"description\":\"description\",\"account_id\":\"accountId\",\"version\":\"version\",\"committed\":false,\"access_group\":{\"name\":\"name\",\"description\":\"description\",\"members\":{\"users\":[\"users\"],\"service_ids\":[\"serviceIds\"],\"action_controls\":{\"add\":false,\"remove\":true}},\"assertions\":{\"rules\":[{\"name\":\"name\",\"expiration\":10,\"realm_name\":\"realmName\",\"conditions\":[{\"claim\":\"claim\",\"operator\":\"operator\",\"value\":\"value\"}],\"action_controls\":{\"remove\":true,\"update\":true}}],\"action_controls\":{\"add\":false,\"remove\":true,\"update\":true}},\"action_controls\":{\"access\":{\"add\":false}}},\"policy_templates\":[{\"id\":\"id\",\"version\":\"version\"}],\"href\":\"href\",\"created_at\":\"createdAt\",\"created_by_id\":\"createdById\",\"last_modified_at\":\"lastModifiedAt\",\"last_modified_by_id\":\"lastModifiedById\"}],\"total_count\":2,\"limit\":1}";
    String mockResponsePage2 = "{\"versions\":[{\"name\":\"name\",\"description\":\"description\",\"account_id\":\"accountId\",\"version\":\"version\",\"committed\":false,\"access_group\":{\"name\":\"name\",\"description\":\"description\",\"members\":{\"users\":[\"users\"],\"service_ids\":[\"serviceIds\"],\"action_controls\":{\"add\":false,\"remove\":true}},\"assertions\":{\"rules\":[{\"name\":\"name\",\"expiration\":10,\"realm_name\":\"realmName\",\"conditions\":[{\"claim\":\"claim\",\"operator\":\"operator\",\"value\":\"value\"}],\"action_controls\":{\"remove\":true,\"update\":true}}],\"action_controls\":{\"add\":false,\"remove\":true,\"update\":true}},\"action_controls\":{\"access\":{\"add\":false}}},\"policy_templates\":[{\"id\":\"id\",\"version\":\"version\"}],\"href\":\"href\",\"created_at\":\"createdAt\",\"created_by_id\":\"createdById\",\"last_modified_at\":\"lastModifiedAt\",\"last_modified_by_id\":\"lastModifiedById\"}],\"total_count\":2,\"limit\":1}";
    server.enqueue(new MockResponse()
      .setHeader("Content-type", "application/json")
      .setResponseCode(200)
      .setBody(mockResponsePage1));
  ...
  public void testListTemplateVersionsWithPagerGetAll() throws Throwable {
    ...
    TemplateVersionsPager pager = new TemplateVersionsPager(iamAccessGroupsService, listTemplateVersionsOptions);
    List<ListTemplatesVersionsResponse> allResults = pager.getAll();
    assertNotNull(allResults);
    assertEquals(allResults.size(), 2);
  }
  ...
  public void testGetTemplateVersionWOptions() throws Throwable {
    ...
    Response<CreateTemplateResponse> response = iamAccessGroupsService.getTemplateVersion(getTemplateVersionOptionsModel).execute();
    assertNotNull(response);
    CreateTemplateResponse responseObj = response.getResult();
    assertNotNull(responseObj);
  ...
  public void testUpdateTemplateVersionWOptions() throws Throwable {
    ...
    Response<CreateTemplateResponse> response = iamAccessGroupsService.updateTemplateVersion(updateTemplateVersionOptionsModel).execute();
    assertNotNull(response);
    CreateTemplateResponse responseObj = response.getResult();
    assertNotNull(responseObj);
  ...
  public void testCommitTemplateWOptions() throws Throwable {
    ...
    Response<CreateTemplateResponse> response = iamAccessGroupsService.commitTemplate(commitTemplateOptionsModel).execute();
    assertNotNull(response);
    CreateTemplateResponse responseObj = response.getResult();
    assertNotNull(responseObj);
  ...
  public void testGetLatestTemplateVersionWOptions() throws Throwable {
    ...
    Response<CreateTemplateResponse> response = iamAccessGroupsService.getLatestTemplateVersion(getLatestTemplateVersionOptionsModel).execute();
    assertNotNull(response);
    CreateTemplateResponse responseObj = response.getResult();
    assertNotNull(responseObj);
  ...
  public void testCreateAssignmentWOptions() throws Throwable {
    ...
    Response<TemplateCreateAssignmentResponse> response = iamAccessGroupsService.createAssignment(createAssignmentOptionsModel).execute();
    assertNotNull(response);
    TemplateCreateAssignmentResponse responseObj = response.getResult();
    assertNotNull(responseObj);
  ...
  public void testListAssignmentsWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "{\"total\": 5, \"limit\": 5, \"offset\": 6, \"groups_assignment\": [{\"id\": \"id\", \"account_id\": \"accountId\", \"template_id\": \"templateId\", \"template_version\": \"templateVersion\", \"target_type\": \"targetType\", \"target\": \"target\", \"operation\": \"operation\", \"status\": \"status\", \"href\": \"href\", \"created_at\": \"2019-01-01T12:00:00.000Z\", \"created_by\": \"createdBy\", \"updated_at\": \"2019-01-01T12:00:00.000Z\", \"updated_by\": \"updatedBy\"}]}";
    ...
    Response<TemplatesListAssignmentResponse> response = iamAccessGroupsService.listAssignments(listAssignmentsOptionsModel).execute();
    assertNotNull(response);
    TemplatesListAssignmentResponse responseObj = response.getResult();
    assertNotNull(responseObj);
  ...
  public void testGetAssignmentWOptions() throws Throwable {
    ...
    Response<GetTemplateAssignmentResponse> response = iamAccessGroupsService.getAssignment(getAssignmentOptionsModel).execute();
    assertNotNull(response);
    GetTemplateAssignmentResponse responseObj = response.getResult();
    assertNotNull(responseObj);
