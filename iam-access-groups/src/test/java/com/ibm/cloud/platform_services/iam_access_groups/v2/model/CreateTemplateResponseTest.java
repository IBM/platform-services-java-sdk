...
public class CreateTemplateResponseTest {
  ...
  public void testCreateTemplateResponse() throws Throwable {
    ...
    assertEquals(createTemplateResponseModel.accessGroup(), accessGroupInputModel);
    assertEquals(createTemplateResponseModel.policyTemplates(), java.util.Arrays.asList(policyTemplatesInputModel));
    ...
    assertEquals(createTemplateResponseModelNew.accessGroup().toString(), accessGroupInputModel.toString());
