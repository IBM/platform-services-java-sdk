 ...
 */
public class ActionControlTemplateCollection extends GenericModel {

  protected Long limit;
  protected First first;
  protected Next next;
  protected Previous previous;
  @SerializedName("action_control_templates")
  protected List<ActionControlTemplate> actionControlTemplates;

  protected ActionControlTemplateCollection() { }
  ...
  /**
   * Gets the actionControlTemplates.
   *
   * List of action control templates.
   *
   * @return the actionControlTemplates
   */
  public List<ActionControlTemplate> getActionControlTemplates() {
    return actionControlTemplates;
  }
}
