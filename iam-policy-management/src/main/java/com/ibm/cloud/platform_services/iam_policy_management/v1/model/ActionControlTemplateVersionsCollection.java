 ...
 */
public class ActionControlTemplateVersionsCollection extends GenericModel {

  protected Long limit;
  protected First first;
  protected Next next;
  protected Previous previous;
  protected List<ActionControlTemplate> versions;

  protected ActionControlTemplateVersionsCollection() { }
   ...
   * @return the versions
   */
  public List<ActionControlTemplate> getVersions() {
    return versions;
  }
}
