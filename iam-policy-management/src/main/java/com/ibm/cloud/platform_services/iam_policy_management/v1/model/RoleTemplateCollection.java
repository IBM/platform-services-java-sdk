 ...
 */
public class RoleTemplateCollection extends GenericModel {

  protected Long limit;
  protected First first;
  protected Next next;
  protected Previous previous;
  @SerializedName("role_templates")
  protected List<RoleTemplate> roleTemplates;

  protected RoleTemplateCollection() { }
  ...
  /**
   * Gets the roleTemplates.
   *
   * List of role templates.
   *
   * @return the roleTemplates
   */
