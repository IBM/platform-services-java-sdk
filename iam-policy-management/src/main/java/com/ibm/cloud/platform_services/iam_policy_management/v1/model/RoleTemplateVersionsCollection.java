 ...
 */
public class RoleTemplateVersionsCollection extends GenericModel {

  protected Long limit;
  protected First first;
  protected Next next;
  protected Previous previous;
  protected List<RoleTemplate> versions;

  protected RoleTemplateVersionsCollection() { }
   ...
   * @return the versions
   */
  public List<RoleTemplate> getVersions() {
    return versions;
  }
}
