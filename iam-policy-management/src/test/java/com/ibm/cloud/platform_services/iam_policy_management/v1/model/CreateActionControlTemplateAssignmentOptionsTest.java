...
/**
 * Unit test class for the CreateActionControlTemplateAssignmentOptions model.
 */
public class CreateActionControlTemplateAssignmentOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateActionControlTemplateAssignmentOptions() throws Throwable {
    ...
    CreateActionControlTemplateAssignmentOptions createActionControlTemplateAssignmentOptionsModel = new CreateActionControlTemplateAssignmentOptions.Builder()
      ...
      .build();
    assertEquals(createActionControlTemplateAssignmentOptionsModel.target(), assignmentTargetDetailsModel);
    assertEquals(createActionControlTemplateAssignmentOptionsModel.templates(), java.util.Arrays.asList(actionControlAssignmentTemplateModel));
    assertEquals(createActionControlTemplateAssignmentOptionsModel.acceptLanguage(), "default");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateActionControlTemplateAssignmentOptionsError() throws Throwable {
    new CreateActionControlTemplateAssignmentOptions.Builder().build();
  }
