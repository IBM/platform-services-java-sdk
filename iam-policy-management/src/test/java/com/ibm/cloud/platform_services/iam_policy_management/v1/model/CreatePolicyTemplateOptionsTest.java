...
import com.ibm.cloud.platform_services.iam_policy_management.v1.model.TemplateGrantRoles;
...
/**
 * Unit test class for the CreatePolicyTemplateOptions model.
 */
public class CreatePolicyTemplateOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreatePolicyTemplateOptions() throws Throwable {
    ...
    TemplateGrantRoles templateGrantModel = new TemplateGrantRoles.Builder()
    ...
    CreatePolicyTemplateOptions createPolicyTemplateOptionsModel = new CreatePolicyTemplateOptions.Builder()
      ...
      .build();
    assertEquals(createPolicyTemplateOptionsModel.name(), "testString");
    assertEquals(createPolicyTemplateOptionsModel.accountId(), "testString");
    assertEquals(createPolicyTemplateOptionsModel.policy(), templatePolicyModel);
    assertEquals(createPolicyTemplateOptionsModel.description(), "testString");
    assertEquals(createPolicyTemplateOptionsModel.committed(), Boolean.valueOf(true));
    assertEquals(createPolicyTemplateOptionsModel.acceptLanguage(), "default");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreatePolicyTemplateOptionsError() throws Throwable {
    new CreatePolicyTemplateOptions.Builder().build();
  }
