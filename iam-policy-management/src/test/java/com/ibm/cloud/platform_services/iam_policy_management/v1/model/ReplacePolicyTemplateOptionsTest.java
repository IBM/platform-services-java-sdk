...
/**
 * Unit test class for the ReplacePolicyTemplateOptions model.
 */
public class ReplacePolicyTemplateOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReplacePolicyTemplateOptions() throws Throwable {
  ...
  public void testReplacePolicyTemplateOptionsError() throws Throwable {
    new ReplacePolicyTemplateOptions.Builder().build();
  }
