...
/**
 * Unit test class for the RoleAssignmentCollection model.
 */
public class RoleAssignmentCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRoleAssignmentCollection() throws Throwable {
    RoleAssignmentCollection roleAssignmentCollectionModel = new RoleAssignmentCollection();
    assertNull(roleAssignmentCollectionModel.getLimit());
    assertNull(roleAssignmentCollectionModel.getFirst());
    assertNull(roleAssignmentCollectionModel.getNext());
    assertNull(roleAssignmentCollectionModel.getPrevious());
    assertNull(roleAssignmentCollectionModel.getAssignments());
  }
}