...
class IamPolicyManagementV1 extends BaseService {
   ...
   * @param {string} [params.acceptLanguage] - Translation language code.
   * @param {OutgoingHttpHeaders} [params.headers] - Custom request headers
   * @returns {Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.PolicyResponse>>}
   */
  public createPolicy(params: IamPolicyManagementV1.CreatePolicyParams): Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.PolicyResponse>> {
    const _params = extend({}, params);
   ...
   * @returns {Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.PolicyResponse>>}
   */
  public updatePolicy(params: IamPolicyManagementV1.UpdatePolicyParams): Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.PolicyResponse>> {
    const _params = extend({}, params);
   ...
   * @returns {Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.PolicyResponse>>}
   */
  public getPolicy(params: IamPolicyManagementV1.GetPolicyParams): Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.PolicyResponse>> {
    const _params = extend({}, params);
   ...
   * @param {string} [params.acceptLanguage] - Translation language code.
   * @param {OutgoingHttpHeaders} [params.headers] - Custom request headers
   * @returns {Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.CustomRoleResponse>>}
   */
  public createRole(params: IamPolicyManagementV1.CreateRoleParams): Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.CustomRoleResponse>> {
    const _params = extend({}, params);
   ...
   * @returns {Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.CustomRoleResponse>>}
   */
  public updateRole(params: IamPolicyManagementV1.UpdateRoleParams): Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.CustomRoleResponse>> {
    const _params = extend({}, params);
   ...
   * @returns {Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.CustomRoleResponse>>}
   */
  public getRole(params: IamPolicyManagementV1.GetRoleParams): Promise<IamPolicyManagementV1.Response<IamPolicyManagementV1.CustomRoleResponse>> {
    const _params = extend({}, params);
...
namespace IamPolicyManagementV1 {
  ...
  export interface PolicyResponseRolesItem {
