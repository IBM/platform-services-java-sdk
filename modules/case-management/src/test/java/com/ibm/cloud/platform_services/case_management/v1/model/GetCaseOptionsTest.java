...
/**
 * Unit test class for the GetCaseOptions model.
 */
public class GetCaseOptionsTest {
  ...
  public void testGetCaseOptionsError() throws Throwable {
    new GetCaseOptions.Builder().build();
  }
