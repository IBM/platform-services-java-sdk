...
/**
 * Unit test class for the OfferingPayload model.
 */
public class OfferingPayloadTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testOfferingPayload() throws Throwable {
    ...
    String json = TestUtilities.serialize(offeringPayloadModel);

    OfferingPayload offeringPayloadModelNew = TestUtilities.deserialize(json, OfferingPayload.class);
    assertTrue(offeringPayloadModelNew instanceof OfferingPayload);
    assertEquals(offeringPayloadModelNew.name(), "testString");
    assertEquals(offeringPayloadModelNew.type().toString(), offeringPayloadTypeModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testOfferingPayloadError() throws Throwable {
    new OfferingPayload.Builder().build();
  }
