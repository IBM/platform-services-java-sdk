...
/**
 * Unit test class for the StatusPayload model.
 */
public class StatusPayloadTest {
  ...
  @Test
  public void testStatusPayload() throws Throwable {
    StatusPayload statusPayloadModel = new StatusPayload();
    assertNotNull(statusPayloadModel);
  }
}