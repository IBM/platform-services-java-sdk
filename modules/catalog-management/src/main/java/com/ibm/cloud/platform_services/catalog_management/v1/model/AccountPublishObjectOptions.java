...
/**
 * The accountPublishObject options.
 */
public class AccountPublishObjectOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(AccountPublishObjectOptions accountPublishObjectOptions) {
      this.catalogIdentifier = accountPublishObjectOptions.catalogIdentifier;
      this.objectIdentifier = accountPublishObjectOptions.objectIdentifier;
    }
    ...
    /**
     * Builds a AccountPublishObjectOptions.
     *
     * @return the new AccountPublishObjectOptions instance
     */
    public AccountPublishObjectOptions build() {
      return new AccountPublishObjectOptions(this);
    }
     ...
     *
     * @param catalogIdentifier the catalogIdentifier
     * @return the AccountPublishObjectOptions builder
     */
  ...
  protected AccountPublishObjectOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a AccountPublishObjectOptions builder
   */
