...
/**
 * The createObject options.
 */
public class CreateObjectOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(CreateObjectOptions createObjectOptions) {
      this.catalogIdentifier = createObjectOptions.catalogIdentifier;
      this.id = createObjectOptions.id;
      this.name = createObjectOptions.name;
      this.rev = createObjectOptions.rev;
      this.crn = createObjectOptions.crn;
      this.url = createObjectOptions.url;
      this.parentId = createObjectOptions.parentId;
      this.labelI18n = createObjectOptions.labelI18n;
      this.label = createObjectOptions.label;
      this.tags = createObjectOptions.tags;
      this.created = createObjectOptions.created;
      this.updated = createObjectOptions.updated;
      this.shortDescription = createObjectOptions.shortDescription;
      this.shortDescriptionI18n = createObjectOptions.shortDescriptionI18n;
      this.kind = createObjectOptions.kind;
      this.publish = createObjectOptions.publish;
      this.state = createObjectOptions.state;
      this.catalogId = createObjectOptions.catalogId;
      this.catalogName = createObjectOptions.catalogName;
      this.data = createObjectOptions.data;
    }
     ...
     *
     * @return the new CreateObjectOptions instance
     */
     ...
     * @return the CreateObjectOptions builder
     */
  ...
  protected CreateObjectOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a CreateObjectOptions builder
   */
