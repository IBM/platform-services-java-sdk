...
/**
 * The deleteObjectAccess options.
 */
public class DeleteObjectAccessOptions extends GenericModel {
  ...
  public static class Builder {
     ...
     *
     * @return the new DeleteObjectAccessOptions instance
     */
     ...
     *
     * @param catalogIdentifier the catalogIdentifier
     * @return the DeleteObjectAccessOptions builder
     */
   ...
   * New builder.
   *
   * @return a DeleteObjectAccessOptions builder
   */
