...
public class DeleteOperatorOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Builds a DeleteOperatorOptions.
     *
     * @return the new DeleteOperatorOptions instance
     */
     ...
     *
     * @param xAuthRefreshToken the xAuthRefreshToken
     * @return the DeleteOperatorOptions builder
     */
   ...
   * New builder.
   *
   * @return a DeleteOperatorOptions builder
   */
