...
/**
 * The deleteOperators options.
 */
public class DeleteOperatorsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(DeleteOperatorsOptions deleteOperatorsOptions) {
      this.xAuthRefreshToken = deleteOperatorsOptions.xAuthRefreshToken;
      this.clusterId = deleteOperatorsOptions.clusterId;
      this.region = deleteOperatorsOptions.region;
      this.versionLocatorId = deleteOperatorsOptions.versionLocatorId;
    }
     ...
     *
     * @return the new DeleteOperatorsOptions instance
     */
    public DeleteOperatorsOptions build() {
      return new DeleteOperatorsOptions(this);
    }
     ...
     *
     * @param xAuthRefreshToken the xAuthRefreshToken
     * @return the DeleteOperatorsOptions builder
     */
  ...
  protected DeleteOperatorsOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a DeleteOperatorsOptions builder
   */
