 ...
 */
public class GetObjectAuditOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(GetObjectAuditOptions getObjectAuditOptions) {
      this.catalogIdentifier = getObjectAuditOptions.catalogIdentifier;
      this.objectIdentifier = getObjectAuditOptions.objectIdentifier;
    }
    ...
    /**
     * Builds a GetObjectAuditOptions.
     *
     * @return the new GetObjectAuditOptions instance
     */
    public GetObjectAuditOptions build() {
      return new GetObjectAuditOptions(this);
    }
     ...
     *
     * @param catalogIdentifier the catalogIdentifier
     * @return the GetObjectAuditOptions builder
     */
  ...
  protected GetObjectAuditOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a GetObjectAuditOptions builder
   */
