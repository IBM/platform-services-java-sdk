...
public class GetVersionAboutOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Builds a GetVersionAboutOptions.
     *
     * @return the new GetVersionAboutOptions instance
     */
     ...
     *
     * @param versionLocId the versionLocId
     * @return the GetVersionAboutOptions builder
     */
   ...
   * New builder.
   *
   * @return a GetVersionAboutOptions builder
   */
