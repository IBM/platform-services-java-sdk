...
/**
 * The ibmPublishObject options.
 */
public class IbmPublishObjectOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(IbmPublishObjectOptions ibmPublishObjectOptions) {
      this.catalogIdentifier = ibmPublishObjectOptions.catalogIdentifier;
      this.objectIdentifier = ibmPublishObjectOptions.objectIdentifier;
    }
    ...
    /**
     * Builds a IbmPublishObjectOptions.
     *
     * @return the new IbmPublishObjectOptions instance
     */
    public IbmPublishObjectOptions build() {
      return new IbmPublishObjectOptions(this);
    }
     ...
     *
     * @param catalogIdentifier the catalogIdentifier
     * @return the IbmPublishObjectOptions builder
     */
  ...
  protected IbmPublishObjectOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a IbmPublishObjectOptions builder
   */
