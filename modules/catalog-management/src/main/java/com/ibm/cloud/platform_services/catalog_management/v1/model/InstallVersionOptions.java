...
/**
 * The installVersion options.
 */
public class InstallVersionOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(InstallVersionOptions installVersionOptions) {
      this.versionLocId = installVersionOptions.versionLocId;
      this.xAuthRefreshToken = installVersionOptions.xAuthRefreshToken;
      this.clusterId = installVersionOptions.clusterId;
      this.region = installVersionOptions.region;
      this.namespace = installVersionOptions.namespace;
      this.overrideValues = installVersionOptions.overrideValues;
      this.entitlementApikey = installVersionOptions.entitlementApikey;
      this.schematics = installVersionOptions.schematics;
      this.script = installVersionOptions.script;
      this.scriptId = installVersionOptions.scriptId;
      this.versionLocatorId = installVersionOptions.versionLocatorId;
      this.vcenterId = installVersionOptions.vcenterId;
      this.vcenterUser = installVersionOptions.vcenterUser;
      this.vcenterPassword = installVersionOptions.vcenterPassword;
      this.vcenterLocation = installVersionOptions.vcenterLocation;
      this.vcenterDatastore = installVersionOptions.vcenterDatastore;
    }
     ...
     *
     * @return the new InstallVersionOptions instance
     */
    public InstallVersionOptions build() {
      return new InstallVersionOptions(this);
    }
     ...
     *
     * @param versionLocId the versionLocId
     * @return the InstallVersionOptions builder
     */
  ...
  protected InstallVersionOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a InstallVersionOptions builder
   */
