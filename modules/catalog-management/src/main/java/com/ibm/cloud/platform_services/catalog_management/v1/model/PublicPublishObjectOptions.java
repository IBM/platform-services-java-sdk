...
/**
 * The publicPublishObject options.
 */
public class PublicPublishObjectOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Builds a PublicPublishObjectOptions.
     *
     * @return the new PublicPublishObjectOptions instance
     */
     ...
     *
     * @param catalogIdentifier the catalogIdentifier
     * @return the PublicPublishObjectOptions builder
     */
   ...
   * New builder.
   *
   * @return a PublicPublishObjectOptions builder
   */
