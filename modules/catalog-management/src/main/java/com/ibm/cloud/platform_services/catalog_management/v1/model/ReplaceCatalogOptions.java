 ...
 */
public class ReplaceCatalogOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ReplaceCatalogOptions replaceCatalogOptions) {
      ...
      this.id = replaceCatalogOptions.id;
      this.rev = replaceCatalogOptions.rev;
      this.label = replaceCatalogOptions.label;
     ...
     *
     * @return the new ReplaceCatalogOptions instance
     */
    public ReplaceCatalogOptions build() {
      return new ReplaceCatalogOptions(this);
    }
  ...
  protected ReplaceCatalogOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ReplaceCatalogOptions builder
   */
