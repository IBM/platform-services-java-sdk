...
/**
 * The sharedPublishObject options.
 */
public class SharedPublishObjectOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(SharedPublishObjectOptions sharedPublishObjectOptions) {
      this.catalogIdentifier = sharedPublishObjectOptions.catalogIdentifier;
      this.objectIdentifier = sharedPublishObjectOptions.objectIdentifier;
    }
    ...
    /**
     * Builds a SharedPublishObjectOptions.
     *
     * @return the new SharedPublishObjectOptions instance
     */
    public SharedPublishObjectOptions build() {
      return new SharedPublishObjectOptions(this);
    }
     ...
     *
     * @param catalogIdentifier the catalogIdentifier
     * @return the SharedPublishObjectOptions builder
     */
  ...
  protected SharedPublishObjectOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a SharedPublishObjectOptions builder
   */
