...
/**
 * The validateInstall options.
 */
public class ValidateInstallOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ValidateInstallOptions validateInstallOptions) {
      this.versionLocId = validateInstallOptions.versionLocId;
      this.xAuthRefreshToken = validateInstallOptions.xAuthRefreshToken;
      this.clusterId = validateInstallOptions.clusterId;
      this.region = validateInstallOptions.region;
      this.namespace = validateInstallOptions.namespace;
      this.overrideValues = validateInstallOptions.overrideValues;
      this.entitlementApikey = validateInstallOptions.entitlementApikey;
      this.schematics = validateInstallOptions.schematics;
      this.script = validateInstallOptions.script;
      this.scriptId = validateInstallOptions.scriptId;
      this.versionLocatorId = validateInstallOptions.versionLocatorId;
      this.vcenterId = validateInstallOptions.vcenterId;
      this.vcenterUser = validateInstallOptions.vcenterUser;
      this.vcenterPassword = validateInstallOptions.vcenterPassword;
      this.vcenterLocation = validateInstallOptions.vcenterLocation;
      this.vcenterDatastore = validateInstallOptions.vcenterDatastore;
    }
    ...
    /**
     * Builds a ValidateInstallOptions.
     *
     * @return the new ValidateInstallOptions instance
     */
    public ValidateInstallOptions build() {
      return new ValidateInstallOptions(this);
    }
     ...
     *
     * @param versionLocId the versionLocId
     * @return the ValidateInstallOptions builder
     */
  ...
  protected ValidateInstallOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ValidateInstallOptions builder
   */
