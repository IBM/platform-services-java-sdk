...
/**
 * The validationInstall options.
 */
public class ValidationInstallOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ValidationInstallOptions validationInstallOptions) {
      this.versionLocId = validationInstallOptions.versionLocId;
      this.xAuthRefreshToken = validationInstallOptions.xAuthRefreshToken;
      this.clusterId = validationInstallOptions.clusterId;
      this.region = validationInstallOptions.region;
      this.namespace = validationInstallOptions.namespace;
      this.overrideValues = validationInstallOptions.overrideValues;
      this.entitlementApikey = validationInstallOptions.entitlementApikey;
      this.schematics = validationInstallOptions.schematics;
      this.script = validationInstallOptions.script;
      this.scriptId = validationInstallOptions.scriptId;
      this.versionLocatorId = validationInstallOptions.versionLocatorId;
      this.vcenterId = validationInstallOptions.vcenterId;
      this.vcenterPassword = validationInstallOptions.vcenterPassword;
      this.vcenterLocation = validationInstallOptions.vcenterLocation;
    }
    ...
    /**
     * Builds a ValidationInstallOptions.
     *
     * @return the new ValidationInstallOptions instance
     */
    public ValidationInstallOptions build() {
      return new ValidationInstallOptions(this);
    }
     ...
     *
     * @param versionLocId the versionLocId
     * @return the ValidationInstallOptions builder
     */
  ...
  protected ValidationInstallOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ValidationInstallOptions builder
   */
