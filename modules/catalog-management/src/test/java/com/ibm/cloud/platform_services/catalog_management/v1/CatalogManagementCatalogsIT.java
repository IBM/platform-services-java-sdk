...
//
// public class CatalogManagementCatalogsIT extends SdkIntegrationTestBase {
//
...
//
//       // Invoke operation
//       Response<Catalog> replaceResponse = service.replaceCatalog(replaceCatalogOptions).execute();
//       // Validate response
//       assertNotNull(replaceResponse);
//       assertEquals(replaceResponse.getStatusCode(), 200);
//
//       Catalog replacedCatalogResult = replaceResponse.getResult();
//
//       assertNotNull(replacedCatalogResult);
//
//       if(!replacedCatalogResult.tags().equals(tags)){
//         throw new Exception("the two lists are not equal");
//       }
//
//     } catch (
