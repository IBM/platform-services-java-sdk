...
public class CatalogManagementIT extends SdkIntegrationTestBase {
  ...
  public void testCommitVersion() throws Exception {
    try {
      CommitVersionOptions commitVersionOptions = new CommitVersionOptions.Builder().versionLocId("testString").build();
  ...
  public void testGetVersion() throws Exception {
    try {
      GetVersionOptions getVersionOptions = new GetVersionOptions.Builder().versionLocId("testString").build();
