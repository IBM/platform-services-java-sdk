...
//  */
// public class CatalogManagementITOld extends SdkIntegrationTestBase {
//
...
//   private static final String expectedOfferingsURL = "https://cm.globalcatalog.test.cloud.ibm" + ".com/api/v1-beta" +
//       "/catalogs/%s/offerings";
...
//   private static final String expectedOfferingURL = "https://cm.globalcatalog.test.cloud.ibm" + ".com/api/v1-beta" +
//       "/catalogs/%s/offerings/%s";
//
...
//     Response<CatalogSearchResult> response = service
//         .listCatalogs()
//         .execute();
//
//     if (response
...
//               .get(i)
//               .id();
//           DeleteCatalogOptions deleteOptions = new DeleteCatalogOptions.Builder()
//               .catalogIdentifier(id)
//               .build();
//           service
//               .deleteCatalog(deleteOptions)
//               .execute();
//         }
//       }
//     }
...
//     Response<AccumulatedFilters> response = service
...
//     int catalogIndex = -1;
//
//     CreateCatalogOptions createOptions = new CreateCatalogOptions.Builder()
//         .label(expectedLabel)
//         .shortDescription(expectedShortDesc)
//         .build();
//     Response<Catalog> createResponse = service
//         .createCatalog(createOptions)
//         .execute();
//     Catalog createResult = createResponse.getResult();
//
//     Response<CatalogSearchResult> listResponse = service
//         .listCatalogs()
//         .execute();
...
//         .getResources()
//         .get(catalogIndex)
//         .url(), String.format(expectedURL, createResult.id()));
//     assertEquals(result
//         .getResources()
//         .get(catalogIndex)
//         .offeringsUrl(), String.format(expectedOfferingsURL, createResult.id()));
//     assertEquals(result
//         .getResources()
//         .get(catalogIndex)
//         .owningAccount(), expectedAccount);
//     assertFalse(result
//         .getResources()
//         .get(catalogIndex)
//         .catalogFilters()
...
//         .shortDescription(expectedShortDesc)
//         .build();
//     Response<Catalog> response = service
//         .createCatalog(createOptions)
//         .execute();
//     Catalog result = response.getResult();
//
//     DeleteCatalogOptions deleteOptions = new DeleteCatalogOptions.Builder()
//         .catalogIdentifier(result.id())
//         .build();
//     service
//         .deleteCatalog(deleteOptions)
//         .execute();
...
//     Catalog createResult = createResponse.getResult();
//
//     GetCatalogOptions getOptions = new GetCatalogOptions.Builder()
//         .catalogIdentifier(createResult.id())
//         .build();
//     Response<Catalog> getResponse = service
//         .getCatalog(getOptions)
//         .execute();
...
//     Catalog createResult = createResponse.getResult();
//
//     ReplaceCatalogOptions replaceOptions = new ReplaceCatalogOptions.Builder()
//         .catalogIdentifier(createResult.id())
//         .id(createResult.id())
//         .label(expectedLabelUpdated)
//         .shortDescription(expectedShortDescUpdated)
//         .build();
//     Response<Catalog> replaceResponse = service
//         .replaceCatalog(replaceOptions)
//         .execute();
...
//         .catalogIdentifier(createResult.id())
//         .build();
//     Response<Void> deleteResponse = service
//         .deleteCatalog(deleteOptions)
//         .execute();
//
...
//     CreateCatalogOptions catalogOptions = new CreateCatalogOptions.Builder()
//         .label(expectedLabel)
//         .shortDescription(expectedShortDesc)
//         .build();
//     Response<Catalog> catalogResponse = service
//         .createCatalog(catalogOptions)
//         .execute();
//     Catalog catalogResult = catalogResponse.getResult();
//
//     CreateOfferingOptions offeringOptions = new CreateOfferingOptions.Builder()
//         .catalogIdentifier(catalogResult.id())
//         .name(expectedOfferingName)
//         .label(expectedLabel)
//         .build();
//     Response<Offering> offeringResponse = service
//         .createOffering(offeringOptions)
//         .execute();
...
//     Offering offeringResult = offeringResponse.getResult();
//
//     GetOfferingOptions getOptions = new GetOfferingOptions.Builder()
//         .catalogIdentifier(catalogResult.id())
//         .offeringId(offeringResult.id())
//         .build();
//     Response<Offering> getResponse = service
//         .getOffering(getOptions)
//         .execute();
...
//     Offering offeringResult = offeringResponse.getResult();
//
//     ListOfferingsOptions listOptions = new ListOfferingsOptions.Builder()
//         .catalogIdentifier(catalogResult.id())
//         .build();
//     Response<OfferingSearchResult> listResponse = service
//         .listOfferings(listOptions)
//         .execute();
...
//         .getResources()
//         .get(0)
//         .url(), String.format(expectedOfferingURL, catalogResult.id(), offeringResult.id()));
//     assertEquals(listResult
//         .getResources()
//         .get(0)
//         .label(), expectedLabel);
...
//         .offeringId(offeringResult.id())
//         .build();
//     Response<Void> deleteOfferingResponse = service
//         .deleteOffering(deleteOfferingOptions)
//         .execute();
//
//     DeleteCatalogOptions deleteOptions = new DeleteCatalogOptions.Builder()
//         .catalogIdentifier(catalogResult.id())
...
//         .execute();
//
//     DeleteOfferingOptions deleteOfferingNoCatalogOptions = new DeleteOfferingOptions.Builder()
//         .catalogIdentifier(catalogResult.id())
//         .offeringId(fakeName)
//         .build();
//     service
//         .deleteOffering(deleteOfferingNoCatalogOptions)
//         .execute();
//   }
//
//   @Test
...
//     Offering offeringResult = offeringResponse.getResult();
//
//     ReplaceOfferingOptions replaceOptions = new ReplaceOfferingOptions.Builder()
//         .catalogIdentifier(catalogResult.id())
//         .id(offeringResult.id())
//         .offeringId(offeringResult.id())
...
//           .build();
//       service
//           .replaceOffering(replaceOptions)
//           .execute();
//       fail("Expected NotFoundException.");
//     } catch (NotFoundException e) {
//       assertEquals(e.getStatusCode(), 404);
...
//     final String expectedOfferingURL = "https://cm.globalcatalog.test.cloud.ibm" + ".com/api/v1-beta/catalogs/%s" +
//         "/offerings/%s";
//     final String expectedOfferingZipURL = "https://github.com/operator-framework/community-operators/blob/master" +
//         "/community-operators/jenkins-operator/0.4.0/jenkins-operator.v0.4.0.clusterserviceversion.yaml";
//
//     CreateCatalogOptions catalogOptions = new CreateCatalogOptions.Builder()
//         .label(expectedLabel)
//         .shortDescription(expectedShortDesc)
...
//     Catalog catalogResult = catalogResponse.getResult();
//
//     ImportOfferingOptions offeringOptions = new ImportOfferingOptions.Builder()
//         .catalogIdentifier(catalogResult.id())
//         .zipurl(expectedOfferingZipURL)
//         .xAuthToken(gitToken)
//         .build();
//     Response<Offering> offeringResponse = service
//         .importOffering(offeringOptions)
//         .execute();
//     Offering offeringResult = offeringResponse.getResult();
//
//     DeleteCatalogOptions deleteOptions = new DeleteCatalogOptions.Builder()
...
//     assertEquals(offeringResult
//         .kinds()
//         .size(), expectedOfferingKinds);
//     assertEquals(offeringResult
//         .kinds()
//         .get(0)
//         .targetKind(), expectedOfferingTargetKind);
//     assertEquals(offeringResult
//         .kinds()
//         .get(0)
//         .versions()
//         .size(), expectedOfferingVersions);
//     assertEquals(offeringResult
//         .kinds()
//         .get(0)
//         .versions()
...
//         "/offerings/%s";
//     final String expectedOfferingZipURL = "https://github.com/operator-framework/community-operators/blob/master" +
//         "/community-operators/jenkins-operator/0.3.31/jenkins-operator.v0.3.31.clusterserviceversion.yaml";
//     final String expectedOfferingZipURLUpdate = "https://github.com/operator-framework/community-operators/blob" +
//         "/master/community-operators/jenkins-operator/0.4.0/jenkins-operator.v0.4.0.clusterserviceversion.yaml";
//
//     CreateCatalogOptions catalogOptions = new CreateCatalogOptions.Builder()
//         .label(expectedLabel)
//         .shortDescription(expectedShortDesc)
...
//     Offering offeringResult = offeringResponse.getResult();
//
//     // ImportOfferingVersionOptions newOfferingOptions = new ImportOfferingVersionOptions.Builder()
//     //     .catalogIdentifier(catalogResult.id())
//     //     .offeringId(offeringResult.id())
//     //     .zipurl(expectedOfferingZipURLUpdate)
//     //     .xAuthToken(gitToken)
//     //     .build();
//     // Response<Offering> newOfferingResponse = service
//     //     .importOfferingVersion(newOfferingOptions)
//     //     .execute();
...
//     // assertEquals(newOfferingResult
//     //     .kinds()
//     //     .size(), expectedOfferingKinds);
//     // assertEquals(newOfferingResult
//     //     .kinds()
...
//     //     .versions()
//     //     .get(0)
//     //     .version(), expectedOfferingVersion1);
//     // assertEquals(newOfferingResult
//     //     .kinds()
//     //     .get(0)
//     //     .versions()
...
//     //     .versions()
//     //     .get(1)
//     //     .version(), expectedOfferingVersion2);
//     // assertEquals(newOfferingResult
//     //     .kinds()
//     //     .get(0)
//     //     .versions()
//     //     .get(1)
//     //     .tgzUrl(), expectedOfferingZipURLUpdate);
//   }
//
//   @Test
...
//
//     try {
//       // ImportOfferingVersionOptions offeringOptions = new ImportOfferingVersionOptions.Builder().catalogIdentifier
//       // (catalogResult.id()).offeringId(fakeName).zipurl(expectedOfferingZipURLUpdate).xAuthToken(gitToken).build();
...
//     //     .xAuthToken(gitToken)
//     //     .build();
//     // Response<Offering> reloadOfferingResponse = service
...
//     // assertEquals(reloadOfferingResult.url(), String.format(expectedOfferingURL, catalogResult.id(),
//     //     offeringResult.id()));
...
//     // assertEquals(reloadOfferingResult
//     //     .kinds()
//     //     .size(), expectedOfferingKinds);
//     // assertEquals(reloadOfferingResult
//     //     .kinds()
...
//     Offering offeringResult = offeringResponse.getResult();
//
//     GetVersionOptions getOptions = new GetVersionOptions.Builder()
//         .versionLocId(offeringResult
//             .kinds()
//             .get(0)
//             .versions()
//             .get(0)
...
//     GetVersionOptions getOptions = new GetVersionOptions.Builder()
//         .versionLocId(fakeVersionLocator)
//         .build();
//     service
//         .getVersion(getOptions)
//         .execute();
...
//     Offering offeringResult = offeringResponse.getResult();
//
//     DeleteVersionOptions deleteOption = new DeleteVersionOptions.Builder()
//         .versionLocId(offeringResult
//             .kinds()
//             .get(0)
//             .versions()
...
//     Offering offeringResult = offeringResponse.getResult();
//
//     GetVersionAboutOptions getOptions = new GetVersionAboutOptions.Builder()
//         .versionLocId(offeringResult
//             .kinds()
//             .get(0)
//             .versions()
...
//
//
//     GetVersionUpdatesOptions getOptions = new GetVersionUpdatesOptions.Builder()
//         .versionLocId(offeringResult
//             .kinds()
//             .get(0)
//             .versions()
...
//     // assertEquals(getResult.get(0).getVersionLocator(), newOfferingResult.kinds().get(0).versions().get(1)
//     // .versionLocator());
...
//     final Long expectedTotalPages = 1L;
//
//     // ListLicenseEntitlementsOptions getOptions = new ListLicenseEntitlementsOptions.Builder().licenseProductId
//     // (fakeName).build();
...
//     SearchLicenseVersionsOptions getOptions = new SearchLicenseVersionsOptions.Builder()
//         .q(fakeName)
//         .build();
...
//     SearchLicenseOfferingsOptions getOptions = new SearchLicenseOfferingsOptions.Builder()
//         .q(fakeName)
//         .build();
