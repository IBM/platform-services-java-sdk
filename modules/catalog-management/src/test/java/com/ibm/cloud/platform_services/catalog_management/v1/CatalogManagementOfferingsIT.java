...
//
// public class CatalogManagementOfferingsIT extends SdkIntegrationTestBase {
//
...
//       /*
//       Issues:
//       - when creating offerings "Install Kind" is mandatory and we don't know the details of it
//
//       Goal:
//       - create offering
//       - modify offering
...
//
//       // Invoke operation
//       Response<Offering> createOfferingResponse = service.createOffering(createOfferingOptions).execute();
//       // Validate response
//       assertNotNull(createOfferingResponse);
//       assertEquals(createOfferingResponse.getStatusCode(), 201);
//
//       Offering offeringResult = createOfferingResponse.getResult();
//
