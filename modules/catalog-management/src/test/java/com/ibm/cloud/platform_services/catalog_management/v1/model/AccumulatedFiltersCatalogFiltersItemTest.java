...
/**
 * Unit test class for the AccumulatedFiltersCatalogFiltersItem model.
 */
public class AccumulatedFiltersCatalogFiltersItemTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAccumulatedFiltersCatalogFiltersItem() throws Throwable {
    AccumulatedFiltersCatalogFiltersItem accumulatedFiltersCatalogFiltersItemModel = new AccumulatedFiltersCatalogFiltersItem();
    assertNull(accumulatedFiltersCatalogFiltersItemModel.getCatalog());
    assertNull(accumulatedFiltersCatalogFiltersItemModel.getFilters());
  }
}