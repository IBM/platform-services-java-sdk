...
/**
 * Unit test class for the AccumulatedFilters model.
 */
public class AccumulatedFiltersTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAccumulatedFilters() throws Throwable {
    AccumulatedFilters accumulatedFiltersModel = new AccumulatedFilters();
    assertNull(accumulatedFiltersModel.getAccountFilters());
    assertNull(accumulatedFiltersModel.getCatalogFilters());
  }
}