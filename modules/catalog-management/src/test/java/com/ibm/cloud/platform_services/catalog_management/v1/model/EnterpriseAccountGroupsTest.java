...
/**
 * Unit test class for the EnterpriseAccountGroups model.
 */
public class EnterpriseAccountGroupsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testEnterpriseAccountGroups() throws Throwable {
    ...
    String json = TestUtilities.serialize(enterpriseAccountGroupsModel);

    EnterpriseAccountGroups enterpriseAccountGroupsModelNew = TestUtilities.deserialize(json, EnterpriseAccountGroups.class);
    assertTrue(enterpriseAccountGroupsModelNew instanceof EnterpriseAccountGroups);
    assertEquals(enterpriseAccountGroupsModelNew.keys().toString(), accountGroupModel.toString());
  }
}