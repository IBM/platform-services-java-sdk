...
public class FiltersTest {
  ...
  public void testFilters() throws Throwable {
    ...
    Filters filtersModelNew = TestUtilities.deserialize(json, Filters.class);
    assertTrue(filtersModelNew instanceof Filters);
    assertEquals(filtersModelNew.includeAll(), Boolean.valueOf(true));
    assertEquals(filtersModelNew.idFilters().toString(), idFilterModel.toString());
  }
}