...
/**
 * Unit test class for the HelmPackage model.
 */
public class HelmPackageTest {
  ...
  @Test
  public void testHelmPackage() throws Throwable {
    HelmPackage helmPackageModel = new HelmPackage();
    assertNull(helmPackageModel.getChart());
  }
}