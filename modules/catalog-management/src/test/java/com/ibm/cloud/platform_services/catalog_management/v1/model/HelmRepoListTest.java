...
/**
 * Unit test class for the HelmRepoList model.
 */
public class HelmRepoListTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testHelmRepoList() throws Throwable {
    HelmRepoList helmRepoListModel = new HelmRepoList();
    assertNull(helmRepoListModel.getChart());
  }
}