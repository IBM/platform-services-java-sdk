...
public class OfferingTest {
  ...
  public void testOffering() throws Throwable {
    ...
    assertEquals(offeringModel.providerInfo(), providerInfoModel);
    assertEquals(offeringModel.repoInfo(), repoInfoModel);
    assertEquals(offeringModel.support(), supportModel);
    assertEquals(offeringModel.media(), new java.util.ArrayList<MediaItem>(java.util.Arrays.asList(mediaItemModel)));
    ...
    assertEquals(offeringModelNew.providerInfo().toString(), providerInfoModel.toString());
    assertEquals(offeringModelNew.repoInfo().toString(), repoInfoModel.toString());
    assertEquals(offeringModelNew.support().toString(), supportModel.toString());
  }
}