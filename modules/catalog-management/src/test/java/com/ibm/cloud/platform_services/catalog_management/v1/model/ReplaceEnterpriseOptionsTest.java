...
/**
 * Unit test class for the ReplaceEnterpriseOptions model.
 */
public class ReplaceEnterpriseOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReplaceEnterpriseOptions() throws Throwable {
    ...
    ReplaceEnterpriseOptions replaceEnterpriseOptionsModel = new ReplaceEnterpriseOptions.Builder()
      ...
      .build();
    assertEquals(replaceEnterpriseOptionsModel.enterpriseId(), "testString");
    assertEquals(replaceEnterpriseOptionsModel.id(), "testString");
    assertEquals(replaceEnterpriseOptionsModel.rev(), "testString");
    assertEquals(replaceEnterpriseOptionsModel.accountFilters(), filtersModel);
    assertEquals(replaceEnterpriseOptionsModel.accountGroups(), enterpriseAccountGroupsModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testReplaceEnterpriseOptionsError() throws Throwable {
    new ReplaceEnterpriseOptions.Builder().build();
  }
