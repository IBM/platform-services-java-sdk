 ...
 */
public class ReplaceOfferingOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReplaceOfferingOptions() throws Throwable {
    ...
    assertEquals(replaceOfferingOptionsModel.id(), "testString");
    assertEquals(replaceOfferingOptionsModel.rev(), "testString");
    assertEquals(replaceOfferingOptionsModel.url(), "testString");
    assertEquals(replaceOfferingOptionsModel.crn(), "testString");
    assertEquals(replaceOfferingOptionsModel.label(), "testString");
    assertEquals(replaceOfferingOptionsModel.name(), "testString");
    assertEquals(replaceOfferingOptionsModel.offeringIconUrl(), "testString");
    assertEquals(replaceOfferingOptionsModel.offeringDocsUrl(), "testString");
    assertEquals(replaceOfferingOptionsModel.offeringSupportUrl(), "testString");
    assertEquals(replaceOfferingOptionsModel.tags(), new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
    assertEquals(replaceOfferingOptionsModel.keywords(), new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
    assertEquals(replaceOfferingOptionsModel.rating(), ratingModel);
    assertEquals(replaceOfferingOptionsModel.created(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(replaceOfferingOptionsModel.updated(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(replaceOfferingOptionsModel.shortDescription(), "testString");
    assertEquals(replaceOfferingOptionsModel.longDescription(), "testString");
    assertEquals(replaceOfferingOptionsModel.features(), new java.util.ArrayList<Feature>(java.util.Arrays.asList(featureModel)));
    assertEquals(replaceOfferingOptionsModel.kinds(), new java.util.ArrayList<Kind>(java.util.Arrays.asList(kindModel)));
    assertEquals(replaceOfferingOptionsModel.permitRequestIbmPublicPublish(), Boolean.valueOf(true));
    assertEquals(replaceOfferingOptionsModel.ibmPublishApproved(), Boolean.valueOf(true));
    assertEquals(replaceOfferingOptionsModel.publicPublishApproved(), Boolean.valueOf(true));
    assertEquals(replaceOfferingOptionsModel.publicOriginalCrn(), "testString");
    assertEquals(replaceOfferingOptionsModel.publishPublicCrn(), "testString");
    assertEquals(replaceOfferingOptionsModel.portalApprovalRecord(), "testString");
    assertEquals(replaceOfferingOptionsModel.portalUiUrl(), "testString");
    assertEquals(replaceOfferingOptionsModel.catalogId(), "testString");
    assertEquals(replaceOfferingOptionsModel.catalogName(), "testString");
    assertEquals(replaceOfferingOptionsModel.metadata(), new java.util.HashMap<String, Object>() { { put("foo", "testString"); } });
  ...
  public void testReplaceOfferingOptionsError() throws Throwable {
    new ReplaceOfferingOptions.Builder().build();
  }
