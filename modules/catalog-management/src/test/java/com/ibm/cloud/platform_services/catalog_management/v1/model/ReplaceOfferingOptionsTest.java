...
public class ReplaceOfferingOptionsTest {
  ...
  public void testReplaceOfferingOptions() throws Throwable {
    ...
    assertEquals(replaceOfferingOptionsModel.created(), TestUtilities.createMockDateTime("2019-01-01T12:00:00"));
    assertEquals(replaceOfferingOptionsModel.updated(), TestUtilities.createMockDateTime("2019-01-01T12:00:00"));
