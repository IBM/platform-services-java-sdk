...
/**
 * Unit test class for the VersionEntitlement model.
 */
public class VersionEntitlementTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testVersionEntitlement() throws Throwable {
    ...
    String json = TestUtilities.serialize(versionEntitlementModel);

    VersionEntitlement versionEntitlementModelNew = TestUtilities.deserialize(json, VersionEntitlement.class);
    assertTrue(versionEntitlementModelNew instanceof VersionEntitlement);
    assertEquals(versionEntitlementModelNew.providerName(), "testString");
    assertEquals(versionEntitlementModelNew.providerId(), "testString");
    assertEquals(versionEntitlementModelNew.productId(), "testString");
    assertEquals(versionEntitlementModelNew.imageRepoName(), "testString");
  }
}