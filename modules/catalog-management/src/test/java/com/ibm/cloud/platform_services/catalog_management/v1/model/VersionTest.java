...
public class VersionTest {
  ...
  public void testVersion() throws Throwable {
    ...
    assertEquals(versionModelNew.created().toString(), TestUtilities.createMockDateTime("2019-01-01T12:00:00").toString());
    assertEquals(versionModelNew.updated().toString(), TestUtilities.createMockDateTime("2019-01-01T12:00:00").toString());
    ...
    assertEquals(versionModelNew.metadata().toString(), new java.util.HashMap<String,Object>(){{put("foo", "testString"); }}.toString());
