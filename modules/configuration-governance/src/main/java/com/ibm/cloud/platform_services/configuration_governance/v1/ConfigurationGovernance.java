...
public class ConfigurationGovernance extends BaseService {
 ...
 /**
  ...
  public ServiceCall<Rule> updateRule(UpdateRuleOptions updateRuleOptions) {
    ...
    if (updateRuleOptions.version() != null) {
      contentJson.addProperty("version", updateRuleOptions.version());
    }
    if (updateRuleOptions.ruleType() != null) {
      contentJson.addProperty("rule_type", updateRuleOptions.ruleType());
    }
    if (updateRuleOptions.imports() != null) {
      contentJson.add("imports", com.ibm.cloud.sdk.core.util.GsonSingleton.getGson().toJsonTree(updateRuleOptions.imports()));
    }
