...
/**
 * Unit test class for the AttachmentList model.
 */
public class AttachmentListTest {
  ...
  @Test
  public void testAttachmentList() throws Throwable {
    AttachmentList attachmentListModel = new AttachmentList();
    assertNull(attachmentListModel.getOffset());
    assertNull(attachmentListModel.getLimit());
    assertNull(attachmentListModel.getTotalCount());
    assertNull(attachmentListModel.getFirst());
    assertNull(attachmentListModel.getLast());
    assertNull(attachmentListModel.getAttachments());
  }
}