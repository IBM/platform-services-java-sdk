...
public class AttachmentTest {
  ...
  public void testAttachment() throws Throwable {
    ...
    assertNull(attachmentModel.getAttachmentId());
    assertNull(attachmentModel.getRuleId());
    assertNull(attachmentModel.getAccountId());
    assertNull(attachmentModel.getIncludedScope());
    assertNull(attachmentModel.getExcludedScopes());
  }
}