...
/**
 * Unit test class for the CreateAttachmentsOptions model.
 */
public class CreateAttachmentsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateAttachmentsOptions() throws Throwable {
  ...
  public void testCreateAttachmentsOptionsError() throws Throwable {
    new CreateAttachmentsOptions.Builder().build();
  }
