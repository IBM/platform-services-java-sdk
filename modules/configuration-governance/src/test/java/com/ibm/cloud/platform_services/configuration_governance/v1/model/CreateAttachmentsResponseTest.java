...
/**
 * Unit test class for the CreateAttachmentsResponse model.
 */
public class CreateAttachmentsResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateAttachmentsResponse() throws Throwable {
    CreateAttachmentsResponse createAttachmentsResponseModel = new CreateAttachmentsResponse();
    assertNull(createAttachmentsResponseModel.getAttachments());
  }
}