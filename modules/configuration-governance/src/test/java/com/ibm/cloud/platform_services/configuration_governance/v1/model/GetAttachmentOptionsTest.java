...
public class GetAttachmentOptionsTest {
  ...
  public void testGetAttachmentOptions() throws Throwable {
    GetAttachmentOptions getAttachmentOptionsModel = new GetAttachmentOptions.Builder()
      ...
      .build();
    assertEquals(getAttachmentOptionsModel.ruleId(), "testString");
    assertEquals(getAttachmentOptionsModel.attachmentId(), "testString");
    assertEquals(getAttachmentOptionsModel.transactionId(), "testString");
  }
