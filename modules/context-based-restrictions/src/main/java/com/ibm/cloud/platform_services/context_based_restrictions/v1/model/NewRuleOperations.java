...
public class NewRuleOperations extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing NewRuleOperations instance.
     *
     * @param newRuleOperations the instance to initialize the Builder with
     */
    ...
    /**
     * Adds a new element to apiTypes.
     *
     * @param apiTypes the new element to be added
