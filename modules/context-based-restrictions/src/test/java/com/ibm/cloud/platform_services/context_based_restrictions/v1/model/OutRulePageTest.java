...
/**
 * Unit test class for the OutRulePage model.
 */
public class OutRulePageTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testOutRulePage() throws Throwable {
    OutRulePage outRulePageModel = new OutRulePage();
    assertNull(outRulePageModel.getCount());
    assertNull(outRulePageModel.getRules());
  }
}