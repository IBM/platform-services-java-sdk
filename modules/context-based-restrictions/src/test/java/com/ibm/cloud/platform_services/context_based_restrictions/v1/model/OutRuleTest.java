...
/**
 * Unit test class for the OutRule model.
 */
public class OutRuleTest {
  ...
  @Test
  public void testOutRule() throws Throwable {
    OutRule outRuleModel = new OutRule();
    assertNull(outRuleModel.getId());
    assertNull(outRuleModel.getCrn());
    assertNull(outRuleModel.getDescription());
    assertNull(outRuleModel.getContexts());
    assertNull(outRuleModel.getResources());
    assertNull(outRuleModel.getHref());
    assertNull(outRuleModel.getCreatedAt());
    assertNull(outRuleModel.getCreatedById());
    assertNull(outRuleModel.getLastModifiedAt());
    assertNull(outRuleModel.getLastModifiedById());
  }
}