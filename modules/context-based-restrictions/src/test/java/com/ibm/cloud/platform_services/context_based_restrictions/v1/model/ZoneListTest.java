...
/**
 * Unit test class for the ZoneList model.
 */
public class ZoneListTest {
  ...
  @Test
  public void testZoneList() throws Throwable {
    ZoneList zoneListModel = new ZoneList();
    assertNull(zoneListModel.getCount());
    assertNull(zoneListModel.getZones());
  }
}