...
/**
 * Unit test class for the BillingUnitsList model.
 */
public class BillingUnitsListTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testBillingUnitsList() throws Throwable {
    BillingUnitsList billingUnitsListModel = new BillingUnitsList();
    assertNull(billingUnitsListModel.getRowsCount());
    assertNull(billingUnitsListModel.getNextUrl());
    assertNull(billingUnitsListModel.getResources());
  }
}