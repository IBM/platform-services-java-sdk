...
/**
 * Unit test class for the CreditPool model.
 */
public class CreditPoolTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreditPool() throws Throwable {
    CreditPool creditPoolModel = new CreditPool();
    assertNull(creditPoolModel.getType());
    assertNull(creditPoolModel.getCurrencyCode());
    assertNull(creditPoolModel.getBillingUnitId());
    assertNull(creditPoolModel.getTermCredits());
    assertNull(creditPoolModel.getOverage());
  }
}