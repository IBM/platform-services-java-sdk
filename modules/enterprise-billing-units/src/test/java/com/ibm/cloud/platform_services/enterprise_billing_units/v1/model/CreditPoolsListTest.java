...
/**
 * Unit test class for the CreditPoolsList model.
 */
public class CreditPoolsListTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreditPoolsList() throws Throwable {
    CreditPoolsList creditPoolsListModel = new CreditPoolsList();
    assertNull(creditPoolsListModel.getRowsCount());
    assertNull(creditPoolsListModel.getNextUrl());
    assertNull(creditPoolsListModel.getResources());
  }
}