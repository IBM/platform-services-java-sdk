...
public class ImportAccountToEnterpriseOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ImportAccountToEnterpriseOptions instance.
     *
     * @param importAccountToEnterpriseOptions the instance to initialize the Builder with
     */
