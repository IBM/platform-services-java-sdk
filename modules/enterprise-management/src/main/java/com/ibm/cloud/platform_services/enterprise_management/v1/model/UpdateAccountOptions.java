...
public class UpdateAccountOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateAccountOptions instance.
     *
     * @param updateAccountOptions the instance to initialize the Builder with
     */
  ...
  protected UpdateAccountOptions() { }
