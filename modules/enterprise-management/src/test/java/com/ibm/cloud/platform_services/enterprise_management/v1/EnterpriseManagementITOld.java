 ...
 * TestNG.
 */
public class EnterpriseManagementITOld extends SdkIntegrationTestBase {
    ...
    public void constructService() {
        ...
        assertNotNull(config.get("URL"));
        assertNotNull(config.get("AUTHTYPE"));
        assertNotNull(config.get("AUTH_URL"));
        assertNotNull(config.get("APIKEY"));
        apiKey = config.get("APIKEY");
        assertNotNull(config.get("ENTERPRISE_ID"));
    ...
    //             .sourceAccountId(subsAccountId)
    //             .primaryContactIamId(ownerIamId)
    ...
    @Test
    public void test10_ListEnterprisesWithoutPaging() throws Throwable {
        // TODO: fix the test method name orders
        ...
        assertNotNull(listEnterprisesResponse);

        // TODO: test pager
    }

    @Test
    public void test11_ListEnterprisesWithPagingListFirstPage() throws Throwable{
        ListEnterprisesOptions listEnterprisesOptions = new ListEnterprisesOptions.Builder()
                .enterpriseAccountId(enterpriseId)
                .limit(1)
                .build();
        ...
        assertNotNull(response);
        assertEquals(response.getStatusCode(), 200);
        ListEnterprisesResponse firstPageResult = response.getResult();
        assertNotNull(firstPageResult);
        assertEquals(firstPageResult.getRowsCount(), Long.valueOf(1));

        ListEnterprisesOptions listEnterprisesOptionsSecondPage = new ListEnterprisesOptions.Builder()
                .enterpriseAccountId(enterpriseId)
                .nextDocid(firstPageResult.getNextUrl())
                .limit(1)
                .build();

        Response<ListEnterprisesResponse> secondPageResponse = service.listEnterprises(listEnterprisesOptionsSecondPage)
                .execute();
        assertNotNull(secondPageResponse);
        assertEquals(secondPageResponse.getStatusCode(), 200);

        ListEnterprisesResponse secondPageResult = secondPageResponse.getResult();
        assertNotNull(secondPageResult);
        assertEquals(secondPageResult.getRowsCount(), Long.valueOf(1));
    }

    @Test
    public void test12_GetEnterprise() throws Throwable{
        // TODO fix test case order
    ...
    @Test
    public void test13_UpdateEnterprise() throws Throwable{
        // TODO fix test case order
    ...
    // @Test
    // public void test14_GetAccountById() throws Throwable {
    //     String response2 = accountManagementService.getAccountByAccountId(subsAccountId, token, config.get("AM_HOST"));
    //     JSONObject obj = new JSONObject(response2);
    //     JSONObject obj2 = obj.getJSONObject("entity");
    ...
    // @Test
    // public void test15_GetAccountByIdUsingEnterprise() throws Throwable {
    //     Thread.sleep(35000);
    //     GetAccountOptions getAccountByIdOptions = new GetAccountOptions.Builder()
    ...
    // @Test
    // public void test16_CreateAccountGroupWOptions() throws Throwable {
    ...
    // @Test
    // public void test17_ListAccountGroupsWOptions() throws Throwable {
    //     ListAccountGroupsOptions listAccountGroupsOptions = new ListAccountGroupsOptions.Builder()
    //             .parent(parent)
    //             .enterpriseId(enterpriseId)
    //             .parentAccountGroupId(accountGroupId)
    //             .limit(100)
    //             .build();
    //
    ...
    // @Test
    // public void test18_GetAccountGroupByIdWOptions() throws Throwable {
    ...
    //
    // @Test
    // public void test19_UpdateAccountGroupWOptions() throws Throwable {
    ...
    // @Test
    // public void test20_CreateVerificationCode() throws Throwable {
    ...
    // @Test
    // public void test21_PutConfirmVerificationCode() throws Throwable {
    //     accountManagementService.confirmVerificationCode(email, verificationCode, token, config.get("AM_HOST"));
    // }

    // @Test
    // public void test22_CreateStandardAccount() throws Throwable {
    ...
    // @Test
    // public void test23_GetAccountByAccountIdLastOperation() throws Throwable {
    //     accountManagementService.getAccountByAccountIdLastOperation(accountId, token, config.get("AM_HOST"));
    // }

    // @Test
    // public void test24_GetAccountActivationToken() throws Throwable {
    //     URL url = null;
    //     try {
    //         url = new URL(config.get("DB_URL"));
    //     } catch (MalformedURLException e) {
    ...
    // @Test
    // public void test25_VerifyAMAccount() throws Throwable {
    ...
    // @Test
    // public void test26_ImportAccountToEnterprise() throws Throwable {
    ...
    // @Test
    // public void test27_GetAccountById() throws Throwable {
    //     accountManagementService.getAccountByAccountId(accountId, token, config.get("AM_HOST"));
    // }

    // @Test
    // public void test28_CreateNewAccountInEnterprise() throws Throwable {
    ...
    //
    // @Test
    // public void test29_ListAccountsByQueryParameter() throws Throwable {
    ...
    //
    // @Test
    // public void test30_CreateAccountGroupWOptions() throws Throwable {
    //     CreateAccountGroupOptions createAccountGroupOptionsModel = new CreateAccountGroupOptions.Builder()
    ...
    //
    // @Test
    // public void test31_GetAccountGroupByIdWOptions() throws Throwable {
    //     GetAccountGroupOptions getAccountGroupByIdOptions = new GetAccountGroupOptions.Builder()
    ...
    //
    // @Test
    // public void test32_MoveAccountWithEnterprise() throws Throwable {
