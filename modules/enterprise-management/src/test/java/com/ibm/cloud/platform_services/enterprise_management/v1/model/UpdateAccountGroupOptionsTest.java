...
/**
 * Unit test class for the UpdateAccountGroupOptions model.
 */
public class UpdateAccountGroupOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateAccountGroupOptions() throws Throwable {
    UpdateAccountGroupOptions updateAccountGroupOptionsModel = new UpdateAccountGroupOptions.Builder()
      ...
      .build();
    assertEquals(updateAccountGroupOptionsModel.accountGroupId(), "testString");
