...
public class GetVisibilityOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetVisibilityOptions instance.
     *
     * @param getVisibilityOptions the instance to initialize the Builder with
     */
  ...
  protected GetVisibilityOptions() { }
