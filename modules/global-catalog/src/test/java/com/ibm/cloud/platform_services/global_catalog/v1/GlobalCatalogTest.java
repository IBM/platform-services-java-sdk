...
public class GlobalCatalogTest extends PowerMockTestCase {
  ...
  */
  ...
  public void testGetPricingWOptions() throws Throwable {
    // Schedule some responses.
    String mockResponseBody = "{\"type\": \"type\", \"origin\": \"origin\", \"starting_price\": {\"plan_id\": \"planId\", \"deployment_id\": \"deploymentId\", \"amount\": [{\"country\": \"country\", \"currency\": \"currency\", \"prices\": [{\"quantity_tier\": 12, \"Price\": 5}]}]}, \"metrics\": [{\"metric_id\": \"metricId\", \"tier_model\": \"tierModel\", \"charge_unit_name\": \"chargeUnitName\", \"charge_unit_quantity\": \"chargeUnitQuantity\", \"resource_display_name\": \"resourceDisplayName\", \"charge_unit_display_name\": \"chargeUnitDisplayName\", \"usage_cap_qty\": 11, \"amounts\": [{\"country\": \"country\", \"currency\": \"currency\", \"prices\": [{\"quantity_tier\": 12, \"Price\": 5}]}]}]}";
  ...
  public void testGetAuditLogsWOptions() throws Throwable {
    // Schedule some responses.
    String mockResponseBody = "{\"offset\": 6, \"limit\": 5, \"count\": 5, \"resource_count\": 13, \"first\": \"first\", \"last\": \"last\", \"prev\": \"prev\", \"next\": \"next\", \"resources\": [{\"id\": \"id\", \"effective\": {\"restrictions\": \"restrictions\", \"owner\": \"owner\", \"include\": {\"accounts\": {\"_accountid_\": \"accountid\"}}, \"exclude\": {\"accounts\": {\"_accountid_\": \"accountid\"}}, \"approved\": true}, \"time\": \"time\", \"who_id\": \"whoId\", \"who_name\": \"whoName\", \"who_email\": \"whoEmail\", \"instance\": \"instance\", \"gid\": \"gid\", \"type\": \"type\", \"message\": \"message\", \"data\": {\"mapKey\": \"anyValue\"}}]}";
