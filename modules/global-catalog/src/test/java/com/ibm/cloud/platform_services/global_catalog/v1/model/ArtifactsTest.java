...
/**
 * Unit test class for the Artifacts model.
 */
public class ArtifactsTest {
  ...
  @Test
  public void testArtifacts() throws Throwable {
    Artifacts artifactsModel = new Artifacts();
    assertNull(artifactsModel.getCount());
    assertNull(artifactsModel.getResources());
  }
}