...
/**
 * Unit test class for the DeleteArtifactOptions model.
 */
public class DeleteArtifactOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDeleteArtifactOptions() throws Throwable {
    DeleteArtifactOptions deleteArtifactOptionsModel = new DeleteArtifactOptions.Builder()
      .objectId("testString")
      .artifactId("testString")
      .account("testString")
      .build();
    assertEquals(deleteArtifactOptionsModel.objectId(), "testString");
