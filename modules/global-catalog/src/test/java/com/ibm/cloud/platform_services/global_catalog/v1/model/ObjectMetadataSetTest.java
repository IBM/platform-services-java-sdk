...
public class ObjectMetadataSetTest {
  ...
  public void testObjectMetadataSet() throws Throwable {
    ...
    assertEquals(objectMetadataSetModelNew.service().toString(), objectMetadataBaseServiceModel.toString());
    assertEquals(objectMetadataSetModelNew.plan().toString(), objectMetadataBasePlanModel.toString());
    assertEquals(objectMetadataSetModelNew.template().toString(), objectMetadataBaseTemplateModel.toString());
    assertEquals(objectMetadataSetModelNew.alias().toString(), objectMetadataBaseAliasModel.toString());
    assertEquals(objectMetadataSetModelNew.sla().toString(), objectMetadataBaseSlaModel.toString());
    ...
    assertEquals(objectMetadataSetModelNew.other().toString(), new java.util.HashMap<String,Object>(){{put("foo", "testString"); }}.toString());
