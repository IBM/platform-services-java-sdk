...
/**
 * Unit test class for the Provider model.
 */
public class ProviderTest {
  ...
  public void testProvider() throws Throwable {
    ...
    String json = TestUtilities.serialize(providerModel);

    Provider providerModelNew = TestUtilities.deserialize(json, Provider.class);
    assertTrue(providerModelNew instanceof Provider);
    assertEquals(providerModelNew.email(), "testString");
    assertEquals(providerModelNew.name(), "testString");
    assertEquals(providerModelNew.contact(), "testString");
