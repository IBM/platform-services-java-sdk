...
/**
 * Unit test class for the URLS model.
 */
public class URLSTest {
  ...
  public void testURLS() throws Throwable {
    ...
    URLS urlsModelNew = TestUtilities.deserialize(json, URLS.class);
    assertTrue(urlsModelNew instanceof URLS);
    assertEquals(urlsModelNew.docUrl(), "testString");
    assertEquals(urlsModelNew.instructionsUrl(), "testString");
    assertEquals(urlsModelNew.apiUrl(), "testString");
    assertEquals(urlsModelNew.createUrl(), "testString");
    assertEquals(urlsModelNew.sdkDownloadUrl(), "testString");
    assertEquals(urlsModelNew.termsUrl(), "testString");
