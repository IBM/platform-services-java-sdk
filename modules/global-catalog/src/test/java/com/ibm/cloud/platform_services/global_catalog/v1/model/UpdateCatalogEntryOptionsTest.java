...
public class UpdateCatalogEntryOptionsTest {
  ...
  public void testUpdateCatalogEntryOptions() throws Throwable {
    ...
    assertEquals(updateCatalogEntryOptionsModel.overviewUi(), java.util.Collections.singletonMap("key1", overviewModel));
    ...
    assertEquals(updateCatalogEntryOptionsModel.tags(), java.util.Arrays.asList("testString"));
    ...
    assertEquals(updateCatalogEntryOptionsModel.url(), "testString");
