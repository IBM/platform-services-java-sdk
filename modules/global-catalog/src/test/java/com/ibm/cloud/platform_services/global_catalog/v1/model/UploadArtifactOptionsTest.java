...
/**
 * Unit test class for the UploadArtifactOptions model.
 */
public class UploadArtifactOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUploadArtifactOptions() throws Throwable {
    UploadArtifactOptions uploadArtifactOptionsModel = new UploadArtifactOptions.Builder()
      ...
      .account("testString")
      .build();
    assertEquals(uploadArtifactOptionsModel.objectId(), "testString");
    assertEquals(uploadArtifactOptionsModel.artifactId(), "testString");
    assertEquals(IOUtils.toString(uploadArtifactOptionsModel.artifact()), IOUtils.toString(TestUtilities.createMockStream("This is a mock file.")));
