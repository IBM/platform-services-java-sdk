...
/**
 * Unit test class for the GetSupportedTypesOptions model.
 */
public class GetSupportedTypesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetSupportedTypesOptions() throws Throwable {
    GetSupportedTypesOptions getSupportedTypesOptionsModel = new GetSupportedTypesOptions();
    assertNotNull(getSupportedTypesOptionsModel);
  }
}