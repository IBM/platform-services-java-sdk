...
/**
 * Unit test class for the ResultItem model.
 */
public class ResultItemTest {
  ...
  @Test
  public void testResultItem() throws Throwable {
    ResultItem resultItemModel = new ResultItem();
    assertNull(resultItemModel.getCrn());
  }
}