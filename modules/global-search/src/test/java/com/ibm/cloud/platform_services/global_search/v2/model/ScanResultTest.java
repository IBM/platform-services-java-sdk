...
/**
 * Unit test class for the ScanResult model.
 */
public class ScanResultTest {
  ...
  @Test
  public void testScanResult() throws Throwable {
    ScanResult scanResultModel = new ScanResult();
    assertNull(scanResultModel.getSearchCursor());
    assertNull(scanResultModel.getLimit());
    assertNull(scanResultModel.getItems());
  }
}