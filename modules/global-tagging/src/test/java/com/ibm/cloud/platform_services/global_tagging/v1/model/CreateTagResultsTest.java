...
/**
 * Unit test class for the CreateTagResults model.
 */
public class CreateTagResultsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateTagResults() throws Throwable {
    CreateTagResults createTagResultsModel = new CreateTagResults();
    assertNull(createTagResultsModel.getResults());
  }
}