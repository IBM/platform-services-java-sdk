...
/**
 * Unit test class for the TagResults model.
 */
public class TagResultsTest {
  ...
  @Test
  public void testTagResults() throws Throwable {
    TagResults tagResultsModel = new TagResults();
    assertNull(tagResultsModel.getResults());
  }
}