...
/**
 * Unit test class for the AddGroupMembersResponse model.
 */
public class AddGroupMembersResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAddGroupMembersResponse() throws Throwable {
    AddGroupMembersResponse addGroupMembersResponseModel = new AddGroupMembersResponse();
    assertNull(addGroupMembersResponseModel.getMembers());
  }
}