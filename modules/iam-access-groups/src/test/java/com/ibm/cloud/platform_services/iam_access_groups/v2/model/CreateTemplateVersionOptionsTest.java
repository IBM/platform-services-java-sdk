...
public class CreateTemplateVersionOptionsTest {
  ...
  public void testCreateTemplateVersionOptions() throws Throwable {
    ...
    assertEquals(createTemplateVersionOptionsModel.accessGroup(), accessGroupInputModel);
    assertEquals(createTemplateVersionOptionsModel.policyTemplates(), java.util.Arrays.asList(policyTemplatesInputModel));
