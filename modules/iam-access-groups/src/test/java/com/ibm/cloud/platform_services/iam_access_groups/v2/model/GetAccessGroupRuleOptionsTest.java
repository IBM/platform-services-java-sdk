...
/**
 * Unit test class for the GetAccessGroupRuleOptions model.
 */
public class GetAccessGroupRuleOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetAccessGroupRuleOptions() throws Throwable {
    GetAccessGroupRuleOptions getAccessGroupRuleOptionsModel = new GetAccessGroupRuleOptions.Builder()
      ...
      .build();
    assertEquals(getAccessGroupRuleOptionsModel.accessGroupId(), "testString");
