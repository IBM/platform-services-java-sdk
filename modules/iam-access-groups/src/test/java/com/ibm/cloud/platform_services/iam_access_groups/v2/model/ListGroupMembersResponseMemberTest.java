...
/**
 * Unit test class for the ListGroupMembersResponseMember model.
 */
public class ListGroupMembersResponseMemberTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListGroupMembersResponseMember() throws Throwable {
    ...
    assertNull(listGroupMembersResponseMemberModel.getHref());
    assertNull(listGroupMembersResponseMemberModel.getCreatedAt());
    assertNull(listGroupMembersResponseMemberModel.getCreatedById());
  }
}