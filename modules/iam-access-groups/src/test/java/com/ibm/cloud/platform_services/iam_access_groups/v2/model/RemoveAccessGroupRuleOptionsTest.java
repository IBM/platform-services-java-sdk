...
/**
 * Unit test class for the RemoveAccessGroupRuleOptions model.
 */
public class RemoveAccessGroupRuleOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRemoveAccessGroupRuleOptions() throws Throwable {
    RemoveAccessGroupRuleOptions removeAccessGroupRuleOptionsModel = new RemoveAccessGroupRuleOptions.Builder()
      ...
      .build();
    assertEquals(removeAccessGroupRuleOptionsModel.accessGroupId(), "testString");
