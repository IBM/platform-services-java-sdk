...
/**
 * Unit test class for the RemoveMemberFromAccessGroupOptions model.
 */
public class RemoveMemberFromAccessGroupOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRemoveMemberFromAccessGroupOptions() throws Throwable {
    RemoveMemberFromAccessGroupOptions removeMemberFromAccessGroupOptionsModel = new RemoveMemberFromAccessGroupOptions.Builder()
      ...
      .build();
    assertEquals(removeMemberFromAccessGroupOptionsModel.accessGroupId(), "testString");
