...
/**
 * Unit test class for the UpdateAccessGroupOptions model.
 */
public class UpdateAccessGroupOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateAccessGroupOptions() throws Throwable {
    UpdateAccessGroupOptions updateAccessGroupOptionsModel = new UpdateAccessGroupOptions.Builder()
      ...
      .build();
    assertEquals(updateAccessGroupOptionsModel.accessGroupId(), "testString");
    assertEquals(updateAccessGroupOptionsModel.ifMatch(), "testString");
    assertEquals(updateAccessGroupOptionsModel.name(), "testString");
