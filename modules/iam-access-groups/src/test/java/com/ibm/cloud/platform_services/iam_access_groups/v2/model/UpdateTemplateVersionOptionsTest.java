...
/**
 * Unit test class for the UpdateTemplateVersionOptions model.
 */
public class UpdateTemplateVersionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateTemplateVersionOptions() throws Throwable {
    ...
    UpdateTemplateVersionOptions updateTemplateVersionOptionsModel = new UpdateTemplateVersionOptions.Builder()
      ...
      .build();
    assertEquals(updateTemplateVersionOptionsModel.templateId(), "testString");
    assertEquals(updateTemplateVersionOptionsModel.versionNum(), "testString");
    assertEquals(updateTemplateVersionOptionsModel.ifMatch(), "testString");
    assertEquals(updateTemplateVersionOptionsModel.id(), "testString");
    assertEquals(updateTemplateVersionOptionsModel.name(), "testString");
    assertEquals(updateTemplateVersionOptionsModel.description(), "testString");
    assertEquals(updateTemplateVersionOptionsModel.accountId(), "testString");
    assertEquals(updateTemplateVersionOptionsModel.version(), "testString");
    assertEquals(updateTemplateVersionOptionsModel.committed(), Boolean.valueOf(true));
    assertEquals(updateTemplateVersionOptionsModel.accessGroup(), accessGroupInputModel);
    assertEquals(updateTemplateVersionOptionsModel.policyTemplates(), java.util.Arrays.asList(policyTemplatesInputModel));
    assertEquals(updateTemplateVersionOptionsModel.href(), "testString");
    assertEquals(updateTemplateVersionOptionsModel.createdAt(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(updateTemplateVersionOptionsModel.createdById(), "testString");
    assertEquals(updateTemplateVersionOptionsModel.lastModifiedAt(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(updateTemplateVersionOptionsModel.lastModifiedById(), "testString");
    assertEquals(updateTemplateVersionOptionsModel.transactionId(), "83adf5bd-de790caa3");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateTemplateVersionOptionsError() throws Throwable {
    new UpdateTemplateVersionOptions.Builder().build();
  }
