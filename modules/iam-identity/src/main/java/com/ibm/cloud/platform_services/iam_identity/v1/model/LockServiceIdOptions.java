 ...
 */
public class LockServiceIdOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Builds a LockServiceIdOptions.
     *
     * @return the new LockServiceIdOptions instance
     */
    public LockServiceIdOptions build() {
      return new LockServiceIdOptions(this);
    }
     ...
     *
     * @param id the id
     * @return the LockServiceIdOptions builder
     */
   ...
   * New builder.
   *
   * @return a LockServiceIdOptions builder
   */
