...
//                    .build();
    ...
    public void testDeleteServiceIDGroup() throws Exception {
        try {
            ...
            Response<ExceptionResponse> response = service.deleteServiceIdGroup(deleteServiceIdGroupOptions).execute();
            assertNotNull(response);
            assertEquals(response.getStatusCode(), 204);
...
//                    .allowedIpAddresses("testString")
    ...
    public void testDeletePreferenceOnScopeAccount() throws Exception {
        ...
        try {
            ...
            Response<ExceptionResponse> response = service.deletePreferencesOnScopeAccount(deletePreferenceOption).execute();
            assertNotNull(response);
            assertEquals(response.getStatusCode(), 204);
