...
public class IamIdentityTest {
  ...
  public void testDeleteServiceIdGroupWOptions() throws Throwable {
    ...
    Response<ExceptionResponse> response = iamIdentityService.deleteServiceIdGroup(deleteServiceIdGroupOptionsModel).execute();
    assertNotNull(response);
  ...
  public void testDeletePreferencesOnScopeAccountWOptions() throws Throwable {
    ...
    Response<ExceptionResponse> response = iamIdentityService.deletePreferencesOnScopeAccount(deletePreferencesOnScopeAccountOptionsModel).execute();
    assertNotNull(response);
    ExceptionResponse responseObj = response.getResult();
    assertNull(responseObj);
