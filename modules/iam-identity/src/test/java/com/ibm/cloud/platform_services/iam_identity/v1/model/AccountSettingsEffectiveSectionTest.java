...
/**
 * Unit test class for the AccountSettingsEffectiveSection model.
 */
public class AccountSettingsEffectiveSectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAccountSettingsEffectiveSection() throws Throwable {
    ...
    assertNull(accountSettingsEffectiveSectionModel.getSessionExpirationInSeconds());
    assertNull(accountSettingsEffectiveSectionModel.getSessionInvalidationInSeconds());
    assertNull(accountSettingsEffectiveSectionModel.getMaxSessionsPerIdentity());
    assertNull(accountSettingsEffectiveSectionModel.getSystemAccessTokenExpirationInSeconds());
    assertNull(accountSettingsEffectiveSectionModel.getSystemRefreshTokenExpirationInSeconds());
  }
}