...
/**
 * Unit test class for the IdBasedMfaEnrollment model.
 */
public class IdBasedMfaEnrollmentTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testIdBasedMfaEnrollment() throws Throwable {
    IdBasedMfaEnrollment idBasedMfaEnrollmentModel = new IdBasedMfaEnrollment();
    assertNull(idBasedMfaEnrollmentModel.getTraitAccountDefault());
