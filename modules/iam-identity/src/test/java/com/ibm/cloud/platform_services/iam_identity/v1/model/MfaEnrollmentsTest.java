...
/**
 * Unit test class for the MfaEnrollments model.
 */
public class MfaEnrollmentsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testMfaEnrollments() throws Throwable {
    MfaEnrollments mfaEnrollmentsModel = new MfaEnrollments();
    assertNull(mfaEnrollmentsModel.getEffectiveMfaType());
    assertNull(mfaEnrollmentsModel.getIdBasedMfa());
    assertNull(mfaEnrollmentsModel.getAccountBasedMfa());
  }
}