...
/**
 * Unit test class for the ProfileClaimRuleList model.
 */
public class ProfileClaimRuleListTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testProfileClaimRuleList() throws Throwable {
    ProfileClaimRuleList profileClaimRuleListModel = new ProfileClaimRuleList();
    assertNull(profileClaimRuleListModel.getContext());
    assertNull(profileClaimRuleListModel.getRules());
  }
}