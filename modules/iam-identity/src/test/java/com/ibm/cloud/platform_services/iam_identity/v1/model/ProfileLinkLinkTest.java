...
/**
 * Unit test class for the ProfileLinkLink model.
 */
public class ProfileLinkLinkTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testProfileLinkLink() throws Throwable {
    ProfileLinkLink profileLinkLinkModel = new ProfileLinkLink();
