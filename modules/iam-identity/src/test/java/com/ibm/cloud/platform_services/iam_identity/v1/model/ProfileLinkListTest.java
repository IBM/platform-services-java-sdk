...
/**
 * Unit test class for the ProfileLinkList model.
 */
public class ProfileLinkListTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testProfileLinkList() throws Throwable {
    ProfileLinkList profileLinkListModel = new ProfileLinkList();
    assertNull(profileLinkListModel.getLinks());
  }
}