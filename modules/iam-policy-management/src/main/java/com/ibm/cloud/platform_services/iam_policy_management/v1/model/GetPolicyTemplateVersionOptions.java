...
public class GetPolicyTemplateVersionOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetPolicyTemplateVersionOptions instance.
     *
     * @param getPolicyTemplateVersionOptions the instance to initialize the Builder with
     */
    ...
    /**
     * Builds a GetPolicyTemplateVersionOptions.
     *
     * @return the new GetPolicyTemplateVersionOptions instance
     */
     ...
     *
     * @param policyTemplateId the policyTemplateId
     * @return the GetPolicyTemplateVersionOptions builder
     */
   ...
   * New builder.
   *
   * @return a GetPolicyTemplateVersionOptions builder
   */
