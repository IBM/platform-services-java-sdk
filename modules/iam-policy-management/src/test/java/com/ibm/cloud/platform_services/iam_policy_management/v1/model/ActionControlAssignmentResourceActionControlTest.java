...
/**
 * Unit test class for the ActionControlAssignmentResourceActionControl model.
 */
public class ActionControlAssignmentResourceActionControlTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testActionControlAssignmentResourceActionControl() throws Throwable {
    ActionControlAssignmentResourceActionControl actionControlAssignmentResourceActionControlModel = new ActionControlAssignmentResourceActionControl();
    assertNull(actionControlAssignmentResourceActionControlModel.getResourceCreated());
    assertNull(actionControlAssignmentResourceActionControlModel.getErrorMessage());
  }
}