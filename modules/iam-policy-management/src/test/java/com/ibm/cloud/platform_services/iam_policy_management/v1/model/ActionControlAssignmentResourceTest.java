...
/**
 * Unit test class for the ActionControlAssignmentResource model.
 */
public class ActionControlAssignmentResourceTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testActionControlAssignmentResource() throws Throwable {
    ActionControlAssignmentResource actionControlAssignmentResourceModel = new ActionControlAssignmentResource();
    assertNull(actionControlAssignmentResourceModel.getTarget());
    assertNull(actionControlAssignmentResourceModel.getActionControl());
  }
}