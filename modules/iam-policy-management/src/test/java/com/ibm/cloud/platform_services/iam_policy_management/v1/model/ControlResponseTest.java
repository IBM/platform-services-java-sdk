...
/**
 * Unit test class for the ControlResponse model.
 */
public class ControlResponseTest {
  ...
  @Test
  public void testControlResponse() throws Throwable {
    ControlResponse controlResponseModel = new ControlResponse();
    assertNotNull(controlResponseModel);
  }
}