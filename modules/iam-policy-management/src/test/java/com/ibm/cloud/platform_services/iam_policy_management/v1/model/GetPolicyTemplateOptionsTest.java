...
/**
 * Unit test class for the GetPolicyTemplateOptions model.
 */
public class GetPolicyTemplateOptionsTest {
  ...
  public void testGetPolicyTemplateOptionsError() throws Throwable {
    new GetPolicyTemplateOptions.Builder().build();
  }
