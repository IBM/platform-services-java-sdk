...
/**
 * Unit test class for the PolicyAssignmentRecord model.
 */
public class PolicyAssignmentRecordTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPolicyAssignmentRecord() throws Throwable {
    PolicyAssignmentRecord policyAssignmentRecordModel = new PolicyAssignmentRecord();
    assertNull(policyAssignmentRecordModel.getTemplateId());
    assertNull(policyAssignmentRecordModel.getTemplateVersion());
