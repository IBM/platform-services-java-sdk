...
/**
 * Unit test class for the PolicyAssignmentResourcesPolicy model.
 */
public class PolicyAssignmentResourcesPolicyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPolicyAssignmentResourcesPolicy() throws Throwable {
