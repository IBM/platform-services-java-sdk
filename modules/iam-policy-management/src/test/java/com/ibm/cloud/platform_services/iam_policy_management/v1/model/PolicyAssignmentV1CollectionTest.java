...
public class PolicyAssignmentV1CollectionTest {
  ...
  public void testPolicyAssignmentV1Collection() throws Throwable {
    ...
    assertNull(policyAssignmentV1CollectionModel.getLimit());
    assertNull(policyAssignmentV1CollectionModel.getFirst());
    assertNull(policyAssignmentV1CollectionModel.getNext());
    assertNull(policyAssignmentV1CollectionModel.getPrevious());
