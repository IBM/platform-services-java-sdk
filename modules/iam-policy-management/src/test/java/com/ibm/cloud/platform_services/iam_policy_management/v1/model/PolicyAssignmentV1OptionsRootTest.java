...
/**
 * Unit test class for the PolicyAssignmentV1OptionsRoot model.
 */
public class PolicyAssignmentV1OptionsRootTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPolicyAssignmentV1OptionsRoot() throws Throwable {
    ...
    String json = TestUtilities.serialize(policyAssignmentV1OptionsRootModel);

    PolicyAssignmentV1OptionsRoot policyAssignmentV1OptionsRootModelNew = TestUtilities.deserialize(json, PolicyAssignmentV1OptionsRoot.class);
    assertTrue(policyAssignmentV1OptionsRootModelNew instanceof PolicyAssignmentV1OptionsRoot);
    assertEquals(policyAssignmentV1OptionsRootModelNew.requesterId(), "testString");
    assertEquals(policyAssignmentV1OptionsRootModelNew.assignmentId(), "testString");
    assertEquals(policyAssignmentV1OptionsRootModelNew.template().toString(), policyAssignmentV1OptionsRootTemplateModel.toString());
  }
}