...
/**
 * Unit test class for the PolicyRequestResourcesItem model.
 */
public class PolicyRequestResourcesItemTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPolicyRequestResourcesItem() throws Throwable {
    ...
    String json = TestUtilities.serialize(policyRequestResourcesItemModel);

    PolicyRequestResourcesItem policyRequestResourcesItemModelNew = TestUtilities.deserialize(json, PolicyRequestResourcesItem.class);
    assertTrue(policyRequestResourcesItemModelNew instanceof PolicyRequestResourcesItem);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testPolicyRequestResourcesItemError() throws Throwable {
    new PolicyRequestResourcesItem.Builder().build();
  }
