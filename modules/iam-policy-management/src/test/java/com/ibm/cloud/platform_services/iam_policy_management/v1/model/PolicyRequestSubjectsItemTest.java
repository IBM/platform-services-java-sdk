...
/**
 * Unit test class for the PolicyRequestSubjectsItem model.
 */
public class PolicyRequestSubjectsItemTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPolicyRequestSubjectsItem() throws Throwable {
    ...
    String json = TestUtilities.serialize(policyRequestSubjectsItemModel);

    PolicyRequestSubjectsItem policyRequestSubjectsItemModelNew = TestUtilities.deserialize(json, PolicyRequestSubjectsItem.class);
    assertTrue(policyRequestSubjectsItemModelNew instanceof PolicyRequestSubjectsItem);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testPolicyRequestSubjectsItemError() throws Throwable {
    new PolicyRequestSubjectsItem.Builder().build();
  }
