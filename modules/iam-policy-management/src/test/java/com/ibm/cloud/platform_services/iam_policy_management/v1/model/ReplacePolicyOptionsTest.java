...
/**
 * Unit test class for the ReplacePolicyOptions model.
 */
public class ReplacePolicyOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReplacePolicyOptions() throws Throwable {
    ...
    ReplacePolicyOptions replacePolicyOptionsModel = new ReplacePolicyOptions.Builder()
      ...
      .build();
    assertEquals(replacePolicyOptionsModel.policyId(), "testString");
    assertEquals(replacePolicyOptionsModel.ifMatch(), "testString");
    assertEquals(replacePolicyOptionsModel.type(), "testString");
    assertEquals(replacePolicyOptionsModel.subjects(), java.util.Arrays.asList(policySubjectModel));
    assertEquals(replacePolicyOptionsModel.roles(), java.util.Arrays.asList(policyRoleModel));
    assertEquals(replacePolicyOptionsModel.resources(), java.util.Arrays.asList(policyResourceModel));
    assertEquals(replacePolicyOptionsModel.description(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testReplacePolicyOptionsError() throws Throwable {
    new ReplacePolicyOptions.Builder().build();
  }
