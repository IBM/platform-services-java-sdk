...
/**
 * Unit test class for the RoleList model.
 */
public class RoleListTest {
  ...
  @Test
  public void testRoleList() throws Throwable {
    RoleList roleListModel = new RoleList();
    assertNull(roleListModel.getCustomRoles());
    assertNull(roleListModel.getServiceRoles());
    assertNull(roleListModel.getSystemRoles());
  }
}