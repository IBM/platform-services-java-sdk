...
/**
 * Unit test class for the V2PolicyBaseResource model.
 */
public class V2PolicyBaseResourceTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testV2PolicyBaseResource() throws Throwable {
    ...
    String json = TestUtilities.serialize(v2PolicyBaseResourceModel);

    V2PolicyBaseResource v2PolicyBaseResourceModelNew = TestUtilities.deserialize(json, V2PolicyBaseResource.class);
    assertTrue(v2PolicyBaseResourceModelNew instanceof V2PolicyBaseResource);
  }
}