...
/**
 * Unit test class for the V2PolicyRuleRuleWithNestedConditions model.
 */
public class V2PolicyRuleRuleWithNestedConditionsTest {
  ...
  public void testV2PolicyRuleRuleWithNestedConditions() throws Throwable {
    ...
    V2PolicyRuleRuleWithNestedConditions v2PolicyRuleRuleWithNestedConditionsModelNew = TestUtilities.deserialize(json, V2PolicyRuleRuleWithNestedConditions.class);
    assertTrue(v2PolicyRuleRuleWithNestedConditionsModelNew instanceof V2PolicyRuleRuleWithNestedConditions);
    assertEquals(v2PolicyRuleRuleWithNestedConditionsModelNew.operator(), "and");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testV2PolicyRuleRuleWithNestedConditionsError() throws Throwable {
    new V2PolicyRuleRuleWithNestedConditions.Builder().build();
  }
