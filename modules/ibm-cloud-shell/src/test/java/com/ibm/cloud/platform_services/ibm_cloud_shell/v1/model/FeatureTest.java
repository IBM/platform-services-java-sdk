...
/**
 * Unit test class for the Feature model.
 */
public class FeatureTest {
  ...
  public void testFeature() throws Throwable {
    ...
    String json = TestUtilities.serialize(featureModel);

    Feature featureModelNew = TestUtilities.deserialize(json, Feature.class);
    assertTrue(featureModelNew instanceof Feature);
    assertEquals(featureModelNew.enabled(), Boolean.valueOf(true));
    assertEquals(featureModelNew.key(), "server.file_manager");
  }
}