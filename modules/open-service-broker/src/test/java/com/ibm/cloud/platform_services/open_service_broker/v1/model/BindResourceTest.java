...
/**
 * Unit test class for the BindResource model.
 */
public class BindResourceTest {
  ...
  @Test
  public void testBindResource() throws Throwable {
    ...
    BindResource bindResourceModelNew = TestUtilities.deserialize(json, BindResource.class);
    assertTrue(bindResourceModelNew instanceof BindResource);
