...
/**
 * Unit test class for the GetServiceInstanceStateOptions model.
 */
public class GetServiceInstanceStateOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetServiceInstanceStateOptions() throws Throwable {
    GetServiceInstanceStateOptions getServiceInstanceStateOptionsModel = new GetServiceInstanceStateOptions.Builder()
      .instanceId("testString")
      .build();
    assertEquals(getServiceInstanceStateOptionsModel.instanceId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetServiceInstanceStateOptionsError() throws Throwable {
    new GetServiceInstanceStateOptions.Builder().build();
  }
