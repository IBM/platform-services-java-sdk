...
/**
 * Unit test class for the ListCatalogOptions model.
 */
public class ListCatalogOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListCatalogOptions() throws Throwable {
    ListCatalogOptions listCatalogOptionsModel = new ListCatalogOptions();
    assertNotNull(listCatalogOptionsModel);
  }
}