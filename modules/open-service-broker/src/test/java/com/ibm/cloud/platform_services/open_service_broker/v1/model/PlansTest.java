...
/**
 * Unit test class for the Plans model.
 */
public class PlansTest {
  ...
  @Test
  public void testPlans() throws Throwable {
    Plans plansModel = new Plans();
    assertNull(plansModel.getDescription());
    assertNull(plansModel.isFree());
    assertNull(plansModel.getId());
    assertNull(plansModel.getName());
  }
}