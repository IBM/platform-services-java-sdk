...
/**
 * Unit test class for the Services model.
 */
public class ServicesTest {
  ...
  public void testServices() throws Throwable {
    ...
    assertNull(servicesModel.isBindable());
    assertNull(servicesModel.getDescription());
    assertNull(servicesModel.getId());
    assertNull(servicesModel.getName());
    assertNull(servicesModel.isPlanUpdateable());
    assertNull(servicesModel.getPlans());
  }
}