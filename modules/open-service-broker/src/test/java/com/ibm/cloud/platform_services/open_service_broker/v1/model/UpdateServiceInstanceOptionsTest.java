...
public class UpdateServiceInstanceOptionsTest {
  ...
  public void testUpdateServiceInstanceOptions() throws Throwable {
    ...
    assertEquals(updateServiceInstanceOptionsModel.context(), new java.util.ArrayList<Context>(java.util.Arrays.asList(contextModel)));
    assertEquals(updateServiceInstanceOptionsModel.parameters(), parametersModel);
    assertEquals(updateServiceInstanceOptionsModel.planId(), "null");
    assertEquals(updateServiceInstanceOptionsModel.previousValues(), new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
    assertEquals(updateServiceInstanceOptionsModel.serviceId(), "null");
    assertEquals(updateServiceInstanceOptionsModel.acceptsIncomplete(), "testString");
  }
