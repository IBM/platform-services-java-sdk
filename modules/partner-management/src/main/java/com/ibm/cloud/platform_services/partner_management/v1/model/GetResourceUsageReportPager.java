...
public class GetResourceUsageReportPager {
  ...
  protected PartnerManagement client;
   ...
   * @param client the PartnerManagement instance to be used to invoke the "getResourceUsageReport" method
   * @param options the GetResourceUsageReportOptions instance to be used to invoke the "getResourceUsageReport" method
   */
  public GetResourceUsageReportPager(PartnerManagement client, GetResourceUsageReportOptions options) {
