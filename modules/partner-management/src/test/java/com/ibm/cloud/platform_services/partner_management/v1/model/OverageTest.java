...
/**
 * Unit test class for the Overage model.
 */
public class OverageTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testOverage() throws Throwable {
    Overage overageModel = new Overage();
    assertNull(overageModel.getCost());
    assertNull(overageModel.getResources());
  }
}