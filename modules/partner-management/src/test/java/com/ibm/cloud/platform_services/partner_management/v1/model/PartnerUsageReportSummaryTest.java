...
/**
 * Unit test class for the PartnerUsageReportSummary model.
 */
public class PartnerUsageReportSummaryTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPartnerUsageReportSummary() throws Throwable {
    PartnerUsageReportSummary partnerUsageReportSummaryModel = new PartnerUsageReportSummary();
    assertNull(partnerUsageReportSummaryModel.getLimit());
    assertNull(partnerUsageReportSummaryModel.getFirst());
    assertNull(partnerUsageReportSummaryModel.getNext());
    assertNull(partnerUsageReportSummaryModel.getReports());
  }
}