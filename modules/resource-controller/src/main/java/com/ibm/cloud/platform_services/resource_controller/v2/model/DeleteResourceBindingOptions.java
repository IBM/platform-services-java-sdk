...
public class DeleteResourceBindingOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DeleteResourceBindingOptions instance.
     *
     * @param deleteResourceBindingOptions the instance to initialize the Builder with
     */
  ...
  protected DeleteResourceBindingOptions() { }
