...
public class ResourceInstancesPager {
  ...
  /**
   * Constructs a new ResourceInstancesPager instance with the specified client and options model instance.
   * @param client the ResourceController instance to be used to invoke the "listResourceInstances" method
   * @param options the ListResourceInstancesOptions instance to be used to invoke the "listResourceInstances" method
   */
   ...
   * @return a List&lt;ResourceInstance&gt; that contains the next page of results
   */
  public List<ResourceInstance> getNext() {
    ...
    ResourceInstancesList result = client.listResourceInstances(options).execute().getResult();
   ...
   * @return a List&lt;ResourceInstance&gt; containing all results returned by the "listResourceInstances" method
   */
  public List<ResourceInstance> getAll() {
    List<ResourceInstance> results = new ArrayList<>();
    while (hasNext()) {
      List<ResourceInstance> nextPage = getNext();
