...
public class ResourceKeysForInstancePager {
  ...
  protected ListResourceKeysForInstanceOptions options;
  protected ResourceController client;
  protected PageContext pageContext;

  // Hide the default ctor.
  protected ResourceKeysForInstancePager() { }

  /**
   * Constructs a new ResourceKeysForInstancePager instance with the specified client and options model instance.
   * @param client the ResourceController instance to be used to invoke the "listResourceKeysForInstance" method
   * @param options the ListResourceKeysForInstanceOptions instance to be used to invoke the "listResourceKeysForInstance" method
   */
  public ResourceKeysForInstancePager(ResourceController client, ListResourceKeysForInstanceOptions options) {
  ...
  public List<ResourceKey> getNext() {
    ...
    ListResourceKeysForInstanceOptions.Builder builder = this.options.newBuilder();
    if (this.pageContext.getNext() != null) {
      builder.start(this.pageContext.getNext());
    }
    this.options = builder.build();

    ResourceKeysList result = client.listResourceKeysForInstance(options).execute().getResult();
   ...
   * @return a List&lt;ResourceKey&gt; containing all results returned by the "listResourceKeysForInstance" method
   */
