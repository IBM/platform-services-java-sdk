...
/**
 * Unit test class for the ListReclamationsOptions model.
 */
public class ListReclamationsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListReclamationsOptions() throws Throwable {
    ListReclamationsOptions listReclamationsOptionsModel = new ListReclamationsOptions.Builder()
      ...
      .build();
    assertEquals(listReclamationsOptionsModel.accountId(), "testString");
    assertEquals(listReclamationsOptionsModel.resourceInstanceId(), "testString");
  }
}