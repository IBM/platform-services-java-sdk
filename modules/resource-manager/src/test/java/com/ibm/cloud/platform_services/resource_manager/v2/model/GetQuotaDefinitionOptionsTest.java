...
/**
 * Unit test class for the GetQuotaDefinitionOptions model.
 */
public class GetQuotaDefinitionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetQuotaDefinitionOptions() throws Throwable {
    GetQuotaDefinitionOptions getQuotaDefinitionOptionsModel = new GetQuotaDefinitionOptions.Builder()
      .id("testString")
      .build();
    assertEquals(getQuotaDefinitionOptionsModel.id(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetQuotaDefinitionOptionsError() throws Throwable {
    new GetQuotaDefinitionOptions.Builder().build();
  }
