...
/**
 * Unit test class for the GetResourceGroupOptions model.
 */
public class GetResourceGroupOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetResourceGroupOptions() throws Throwable {
    GetResourceGroupOptions getResourceGroupOptionsModel = new GetResourceGroupOptions.Builder()
      .id("testString")
      .build();
    assertEquals(getResourceGroupOptionsModel.id(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetResourceGroupOptionsError() throws Throwable {
    new GetResourceGroupOptions.Builder().build();
  }
