...
/**
 * Unit test class for the ListQuotaDefinitionsOptions model.
 */
public class ListQuotaDefinitionsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListQuotaDefinitionsOptions() throws Throwable {
    ListQuotaDefinitionsOptions listQuotaDefinitionsOptionsModel = new ListQuotaDefinitionsOptions();
    assertNotNull(listQuotaDefinitionsOptionsModel);
  }
}