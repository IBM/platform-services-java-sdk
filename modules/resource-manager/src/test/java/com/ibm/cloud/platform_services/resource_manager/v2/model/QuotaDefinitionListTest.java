...
/**
 * Unit test class for the QuotaDefinitionList model.
 */
public class QuotaDefinitionListTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testQuotaDefinitionList() throws Throwable {
    QuotaDefinitionList quotaDefinitionListModel = new QuotaDefinitionList();
    assertNull(quotaDefinitionListModel.getResources());
  }
}