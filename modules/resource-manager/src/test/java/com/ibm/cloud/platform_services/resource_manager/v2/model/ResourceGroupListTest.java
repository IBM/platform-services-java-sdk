...
/**
 * Unit test class for the ResourceGroupList model.
 */
public class ResourceGroupListTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testResourceGroupList() throws Throwable {
    ResourceGroupList resourceGroupListModel = new ResourceGroupList();
    assertNull(resourceGroupListModel.getResources());
  }
}