...
/**
 * Unit test class for the ResponseAccepted model.
 */
public class ResponseAcceptedTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testResponseAccepted() throws Throwable {
    ResponseAccepted responseAcceptedModel = new ResponseAccepted();
    assertNull(responseAcceptedModel.getResources());
  }
}