...
public class GetResourceGroupUsageOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetResourceGroupUsageOptions instance.
     *
     * @param getResourceGroupUsageOptions the instance to initialize the Builder with
     */
  ...
  protected GetResourceGroupUsageOptions() { }
