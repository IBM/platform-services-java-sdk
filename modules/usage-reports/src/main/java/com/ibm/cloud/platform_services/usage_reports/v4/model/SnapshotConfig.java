 ...
 */
public class SnapshotConfig extends GenericModel {
  ...
  protected Double lastUpdatedAt;
  protected List<SnapshotConfigHistoryItem> history;
   ...
   * @return the history
   */
  public List<SnapshotConfigHistoryItem> getHistory() {
    return history;
  }
}
