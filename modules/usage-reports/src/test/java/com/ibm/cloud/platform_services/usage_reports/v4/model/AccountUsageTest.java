...
/**
 * Unit test class for the AccountUsage model.
 */
public class AccountUsageTest {
  ...
  @Test
  public void testAccountUsage() throws Throwable {
    AccountUsage accountUsageModel = new AccountUsage();
    assertNull(accountUsageModel.getAccountId());
    assertNull(accountUsageModel.getPricingCountry());
    assertNull(accountUsageModel.getCurrencyCode());
    assertNull(accountUsageModel.getMonth());
    assertNull(accountUsageModel.getResources());
    assertNull(accountUsageModel.getCurrencyRate());
  }
}