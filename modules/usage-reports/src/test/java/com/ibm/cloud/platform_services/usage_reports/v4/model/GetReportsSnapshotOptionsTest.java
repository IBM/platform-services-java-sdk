...
public class GetReportsSnapshotOptionsTest {
  ...
  public void testGetReportsSnapshotOptions() throws Throwable {
    ...
    assertEquals(getReportsSnapshotOptionsModel.dateFrom(), Double.valueOf("1675209600000"));
    assertEquals(getReportsSnapshotOptionsModel.dateTo(), Double.valueOf("1675987200000"));
  }
