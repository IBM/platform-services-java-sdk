...
/**
 * Unit test class for the InstancesUsage model.
 */
public class InstancesUsageTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testInstancesUsage() throws Throwable {
    InstancesUsage instancesUsageModel = new InstancesUsage();
    assertNull(instancesUsageModel.getLimit());
    assertNull(instancesUsageModel.getCount());
    assertNull(instancesUsageModel.getFirst());
    assertNull(instancesUsageModel.getNext());
    assertNull(instancesUsageModel.getResources());
  }
}