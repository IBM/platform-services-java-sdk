...
/**
 * Unit test class for the OrgUsage model.
 */
public class OrgUsageTest {
  ...
  @Test
  public void testOrgUsage() throws Throwable {
    OrgUsage orgUsageModel = new OrgUsage();
    assertNull(orgUsageModel.getAccountId());
    assertNull(orgUsageModel.getOrganizationId());
    assertNull(orgUsageModel.getOrganizationName());
    assertNull(orgUsageModel.getPricingCountry());
    assertNull(orgUsageModel.getCurrencyCode());
    assertNull(orgUsageModel.getMonth());
    assertNull(orgUsageModel.getResources());
    assertNull(orgUsageModel.getCurrencyRate());
  }
}