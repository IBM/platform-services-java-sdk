...
public class ResourceTest {
  ...
  public void testResource() throws Throwable {
    ...
    assertNull(resourceModel.getNonBillableCost());
    assertNull(resourceModel.getNonBillableRatedCost());
    assertNull(resourceModel.getPlans());
    assertNull(resourceModel.getDiscounts());
  }
}