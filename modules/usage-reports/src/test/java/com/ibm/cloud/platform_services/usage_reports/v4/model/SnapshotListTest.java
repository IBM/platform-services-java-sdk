...
/**
 * Unit test class for the SnapshotList model.
 */
public class SnapshotListTest {
  ...
  @Test
  public void testSnapshotList() throws Throwable {
    SnapshotList snapshotListModel = new SnapshotList();
    assertNull(snapshotListModel.getCount());
    assertNull(snapshotListModel.getFirst());
    assertNull(snapshotListModel.getNext());
    assertNull(snapshotListModel.getSnapshots());
  }
}