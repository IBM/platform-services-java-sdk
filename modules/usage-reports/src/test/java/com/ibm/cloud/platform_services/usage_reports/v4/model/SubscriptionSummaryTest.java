...
/**
 * Unit test class for the SubscriptionSummary model.
 */
public class SubscriptionSummaryTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testSubscriptionSummary() throws Throwable {
    SubscriptionSummary subscriptionSummaryModel = new SubscriptionSummary();
    assertNull(subscriptionSummaryModel.getOverage());
    assertNull(subscriptionSummaryModel.getSubscriptions());
  }
}