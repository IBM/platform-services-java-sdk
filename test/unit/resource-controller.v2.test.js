  ...
  describe('listResourceInstances', () => {
    describe('positive tests', () => {
      test('should pass the right params to createRequest', () => {
        ...
        const updatedFrom = 'testString';
        const updatedTo = 'testString';
        const params = {
          guid: guid,
          name: name,
        ...
        checkUrlAndMethod(options, '/resource_instances', 'GET');
  ...
  describe('createResourceInstance', () => {
    describe('positive tests', () => {
      test('should pass the right params to createRequest', () => {
        ...
        checkUrlAndMethod(options, '/resource_instances', 'POST');
        const expectedAccept = 'application/json';
  ...
  describe('getResourceInstance', () => {
    describe('positive tests', () => {
      test('should pass the right params to createRequest', () => {
        ...
        checkUrlAndMethod(options, '/resource_instances/{id}', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
  ...
  describe('deleteResourceInstance', () => {
    describe('positive tests', () => {
      test('should pass the right params to createRequest', () => {
        ...
        checkUrlAndMethod(options, '/resource_instances/{id}', 'DELETE');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(options.path['id']).toEqual(id);
  ...
  describe('updateResourceInstance', () => {
    describe('positive tests', () => {
      test('should pass the right params to createRequest', () => {
        ...
        checkUrlAndMethod(options, '/resource_instances/{id}', 'PATCH');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(options.body['name']).toEqual(name);
  ...
  describe('listResourceKeys', () => {
    describe('positive tests', () => {
      test('should pass the right params to createRequest', () => {
        ...
        checkUrlAndMethod(options, '/resource_keys', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(options.qs['guid']).toEqual(guid);
  ...
  describe('createResourceKey', () => {
    describe('positive tests', () => {
      ...
      test('should pass the right params to createRequest', () => {
        ...
        checkUrlAndMethod(options, '/resource_keys', 'POST');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(options.body['name']).toEqual(name);
  ...
  describe('getResourceKey', () => {
    describe('positive tests', () => {
      test('should pass the right params to createRequest', () => {
        ...
        checkUrlAndMethod(options, '/resource_keys/{id}', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(options.path['id']).toEqual(id);
  ...
  describe('deleteResourceKey', () => {
    describe('positive tests', () => {
      test('should pass the right params to createRequest', () => {
        ...
        checkUrlAndMethod(options, '/resource_keys/{id}', 'DELETE');
  ...
  describe('updateResourceKey', () => {
    describe('positive tests', () => {
      test('should pass the right params to createRequest', () => {
        ...
        checkUrlAndMethod(options, '/resource_keys/{id}', 'PATCH');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(options.body['name']).toEqual(name);
  ...
  describe('listResourceBindings', () => {
    describe('positive tests', () => {
      test('should pass the right params to createRequest', () => {
        ...
        checkUrlAndMethod(options, '/resource_bindings', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(options.qs['guid']).toEqual(guid);
  ...
  describe('createResourceBinding', () => {
    describe('positive tests', () => {
      ...
      test('should pass the right params to createRequest', () => {
        ...
        const source = '25eba2a9-beef-450b-82cf-f5ad5e36c6dd';
        const target = 'crn:v1:bluemix:public:bluemix:us-south:s/0ba4dba0-a120-4a1e-a124-5a249a904b76::cf-application:a1caa40b-2c24-4da8-8267-ac2c1a42ad0c';
        ...
        checkUrlAndMethod(options, '/resource_bindings', 'POST');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(options.body['source']).toEqual(source);
  ...
  describe('getResourceBinding', () => {
    describe('positive tests', () => {
      test('should pass the right params to createRequest', () => {
        ...
        checkUrlAndMethod(options, '/resource_bindings/{id}', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(options.path['id']).toEqual(id);
  ...
  describe('deleteResourceBinding', () => {
    describe('positive tests', () => {
      test('should pass the right params to createRequest', () => {
        ...
        checkUrlAndMethod(options, '/resource_bindings/{id}', 'DELETE');
        const expectedAccept = undefined;
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(options.path['id']).toEqual(id);
  ...
  describe('updateResourceBinding', () => {
    describe('positive tests', () => {
      test('should pass the right params to createRequest', () => {
        ...
        checkUrlAndMethod(options, '/resource_bindings/{id}', 'PATCH');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(options.body['name']).toEqual(name);
  ...
  describe('listResourceAliases', () => {
    describe('positive tests', () => {
      test('should pass the right params to createRequest', () => {
        ...
        checkUrlAndMethod(options, '/resource_aliases', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(options.qs['guid']).toEqual(guid);
  ...
  describe('createResourceAlias', () => {
    describe('positive tests', () => {
      test('should pass the right params to createRequest', () => {
        ...
        const target = 'crn:v1:staging:public:bluemix:us-south:o/5e939cd5-6377-4383-b9e0-9db22cd11753::cf-space:66c8b915-101a-406c-a784-e6636676e4f5';
        const params = {
          name: name,
          source: source,
          target: target,
        ...
        checkUrlAndMethod(options, '/resource_aliases', 'POST');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(options.body['name']).toEqual(name);
  ...
  describe('getResourceAlias', () => {
    describe('positive tests', () => {
      test('should pass the right params to createRequest', () => {
        ...
        checkUrlAndMethod(options, '/resource_aliases/{id}', 'GET');
        const expectedAccept = 'application/json';
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(options.path['id']).toEqual(id);
  ...
  describe('deleteResourceAlias', () => {
    describe('positive tests', () => {
      test('should pass the right params to createRequest', () => {
        ...
        checkUrlAndMethod(options, '/resource_aliases/{id}', 'DELETE');
        const expectedAccept = undefined;
        const expectedContentType = undefined;
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(options.path['id']).toEqual(id);
  ...
  describe('updateResourceAlias', () => {
    describe('positive tests', () => {
      test('should pass the right params to createRequest', () => {
        ...
        checkUrlAndMethod(options, '/resource_aliases/{id}', 'PATCH');
        const expectedAccept = 'application/json';
        const expectedContentType = 'application/json';
        checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
        expect(options.body['name']).toEqual(name);
